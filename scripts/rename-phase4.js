...
const mapping = {
  ...
  "Emily": "Eleni",
  "Emmett": "Eskil",
  "Vellacott": "Falconieri",
  "Feeler": "Fonseca",
  "Fern": "Faina",
  "Field": "Fjord",
  "Fleener": "Flores-Mihalache",
  "Floyd": "Flavian",
  "Carrowmore": "Friedrich",
  "French": "Fryderyk",
  "Brindleforth": "Gavrilov",
  "Quennelford": "Gunnarsson",
  "Gautam": "Govindan",
  "Gdowski": "Gajewski",
  "Gifford": "Gildardo",
  "Glenn": "Gellert",
...
for (const t of original_unique) {
  ...
  if (replacement === undefined) {
    ...
    if (replacement === t) {
      ...
      ["Brandon","Sterne","Anita","Skarsdale","Beckforth","Beckweldon","Falkenrath","Brennelmark",
       "Tregarthen","Vellacott","Birchington","Roland","Felicity","Adler",
       "Hardenkvist","Vorhelden","Espelheim","Strathorne","Steve","Steven","Rashid","Matthew",
       "Konstantinos","Manolinder","Holvenmark","Curtis","Pendrelle","Bryan","Carwelden",
       "Martin","Ariella","Halverthorne","Jordan","Fryer","Rebecca","Sydney","Blanc",
