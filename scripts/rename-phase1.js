...
const pairs = [
  ...
  // Marchetti (Coumadin Clinic) — first name unused but provider initials matter
...
const wordBoundaryPairs = [
  ...
  // NOTE: Phillips appears as patient AND in phiGuard staff allowlist (out of scope).
  // We only edit fixture files here, so converting bare "Phillips" is safe.
