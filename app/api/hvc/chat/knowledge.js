...
ROLE & CONTEXT:
You are assisting Brandon Sterne, RN BSN, at Cardiology Associates (Lakeside Health, Rolla, MO). Brandon supports Stellan R. Peterson, ARNP (always "Mr. Peterson," never "Dr. Peterson") and also serves the broader cardiology clinic in specific roles.
...
1. RESULT CALLBACK: Peterson sends result note in In Basket. Brandon contacts patient, completes tasks, documents in RN note. See RESULT CALLBACK FORMAT below.

2. CHECKOUT ORDERS: Peterson hands checkout sheet. Brandon enters orders in Epic. Confirm correct Epic order search terms per order entry section. No script or MyChart needed.
...
5. TRIAGE / PATIENT MESSAGES: Patient calls or MyCharts with symptoms, questions, concerns. Brandon assesses, gathers context, handles what RN scope allows, forwards to Peterson provider-ready. See TRIAGE FORMAT (SBAR) below.
...
- MyChart Message: Patient-friendly language, signed "Brandon Sterne, RN BSN / Cardiology Associates," do NOT include clinic phone numbers
...
When Brandon is calling a patient about test results (or sending via MyChart), use this structure. The note documents what Brandon DID -- not what Peterson said. Peterson's instructions are already in the chart directly below this note.

Nurse Note - Brandon Sterne RN BSN

Results reviewed per Peterson.
...
[Actions taken: meds refilled, labs ordered, referrals placed, patient questions answered, information gathered per Peterson's requests, etc.]
...
RULES:
- Document ACTIONS TAKEN, not Peterson's instructions. Do not say "Per Peterson: do X" -- say "X done" or "Ordered X" or "Confirmed X with patient."
- Peterson's original note is visible directly below in the chart -- do not repeat it
- When Brandon posts Peterson's note and says "write RN note," understand that Brandon has COMPLETED the tasks. Write the note as if all actions have been carried out -- calls made, meds refilled, labs ordered, questions asked and answered.
...
- When Peterson asks questions (e.g. "how is BP since restarting med?"), document that you asked and what the patient said
- When Peterson orders something, document that you placed the order
...
TRIAGE FORMAT (SBAR):
When Brandon is triaging a patient call (symptoms, complaints, concerns), use SBAR structure. Keep it SHORT. Peterson is busy in clinic and needs to scan these in seconds.
...
R: Routed to Peterson, [routine/urgent]. Patient advised to [key instruction]. Return precautions provided.

RULES:
- BREVITY IS MANDATORY. Each SBAR section should be 1-3 sentences max. Not paragraphs.
- Background: only include what Peterson needs to make a decision. Cut everything else.
...
- Recommendation: short and direct. "Routed to Peterson, routine." is often sufficient.
...
- Peterson does not need a dissertation. He needs the complaint, the relevant context, and the ask.
...
- INR MyChart messages do NOT reference Peterson or any provider reviewing results.
- Use "Your recent INR results have been reviewed" or "I have reviewed your recent INR results" -- not "Mr. Peterson has reviewed..."
...
SHORTHAND DECODER:
When Peterson's notes contain abbreviations not in the Holvenmark Code or the Peterson Shorthand Decoder, flag it and ask Brandon. Add to knowledge base at end of day.
...
- When Peterson's note contains questions for the patient (confirm meds, assess symptoms, check side effects, etc.) AND Brandon requests a MyChart message:
...
- When Peterson's note contains questions AND Brandon requests a script (phone call):
...
- Eastside Pharmacy in Waynesville can order PEG-free formulations
- Both available Cardizem formulations through Eastside Pharmacy contain PEG (verified 2/17/2026)
...
- Sleep medicine is NOT done at Lakeside -- referred out (Dr. Carlson at Riverview Medical Center, Dr. Tarkenbridge (at Eastview Hospital), etc.)

===== APRIA CPAP/SLEEP THERAPY ORDER FORM =====
Apria Representative: Kathy Kurtz
Branch: ROLLA 0325, Ph: 555-555-4619
Fax completed form to: 555-555-5447
Referral source: Stellan Peterson, ANP-BC
Clinic Ph: 555-555-0103, Fax: 555-555-0102
...
AFTER COMPLETING FORM: Get provider signature, fax to Apria at 555-555-5447. Include patient demographics, insurance info, and signed/dated face-to-face evaluation with test results.
...
- AFTER placing external order: Send Epic staff message to Tamsin Greythorne, Renee Sandriden, Leona Inwarden, and Marlena Carrowmore notifying them the order has been placed and needs pre-certification.
...
5. Class defaults:
   - Internal Referral = service provided at Lakeside
   - Outgoing Referral = outside facility (can override to Outgoing per patient preference even if offered at Lakeside)
...
===== PROVIDER CODE -- DR. HOLVENMARK ABBREVIATIONS =====
...
- Opening: "Mr. Peterson has reviewed your recent [test/results]..."
...
- Signature: "Brandon Sterne, RN BSN / Cardiology Associates"
...
(Build over time. When Peterson uses shorthand not in Holvenmark Code, flag it and add here.)
...
Stellan R. Peterson = ARNP (Advanced Registered Nurse Practitioner)
- Never "Dr. Peterson" -- always "Mr. Peterson" in scripts and documentation

===== PHELPS HEALTH INTERNAL =====

Cardiology Clinic: Ph: 555-555-0101, Fax: 555-555-0102
Central Scheduling: ext 7137, Ph: 555-555-7137
Radiology: ext 7770, 3050, 7775, Fax: (555) 555-8396
Cardiac Rehab: ext 3110, Ph: 555-555-3110
Ultrasound: ext 7104
...
Medical Records: ext 7550, Ph: (555) 555-7550, Fax: (555) 555-8393
Surgery: ext 7832
ICU: ext 7298
PHS EVS: ext 1825
Lakeside Transportation (outside): ext 7962, Ph: (555) 555-0104
Happy Hauler (Lakeside Health): Ph: (555) 555-0105 (8:00am-4:00pm)

PHELPS HEALTH STAFF:
- Dr. Sigrun Lyrika Orveldon: Ph: (555) 555-6365, Fax: (555) 555-6826
- Renee Sandriden -- Referral Coordinator
- Rolla Clinic -- Nurse Kristen: ext 7523
- Insurance: Sorenza ext 8011, Melisande ext 8119
- Sorenza Kelterling -- Lakeside Financial

===== PHELPS HEALTH SPECIALTY CARE =====

(Per Lakeside Health directory, updated February 2026)

CARDIOLOGY/INTERVENTIONAL CARDIOLOGY:
- Konstantinos Manolinder, MD
- Curtis Holvenmark, MD
- Rashid Lambridge, MD
- Stellan Peterson, ANP-BC
- Brendan Lamberton-Vossi, FNP-C
- 1050 West 10th Street, Suite 500, Rolla, MO
- Ph: (555) 555-0103, Fax: (555) 555-2480

ALLERGY/ENT:
- Brian Kriete, MD / Mark Rusten, MD / Candace Chafton, FNP-C / Brittany Waterworth, FNP-C
- Rolla: 1050 West 10th Street, Suite 300 -- Ph: (555) 555-5719, Fax: (555) 555-9629
- Waynesville: 1000 GW Lane Street -- Ph: (555) 555-2715, Fax: (555) 555-9629
- Salem: 1415 West Scenic Rivers Blvd -- Ph: (555) 555-5719, Fax: (555) 555-2466

AUDIOLOGY:
- Alec Deveney, AuD / Larry Mazzeo, AuD
- 600 Blues Lake Parkway, Rolla -- Ph: (555) 555-5719, Fax: (555) 555-9629

BARIATRICS:
- Donny Roshan, DO / Zak Maedgen, PA-C
- 1060 West 10th Street, Rolla -- Ph: (555) 555-2422, Fax: (555) 555-2430

GENERAL SURGERY:
- David Moravec, MD / Donny Roshan, DO / Dana Voight, MD / Zak Maedgen, PA-C / Allison Rowden, PA-C
- 1060 West 10th Street, Rolla -- Ph: (555) 555-2860, Fax: (555) 555-2405

MEDICAL ONCOLOGY/HEMATOLOGY:
- Kan Huang, MD PhD / Mark Pajeau, MD / Logan Shockley, AOCNP / Becky Witham, AOCNP
- 1060 West 10th Street, Rolla -- Ph: (555) 555-3324, Fax: (555) 555-8445

NEPHROLOGY:
- Nurelign Abebe, MD / Syed Mueen Zahoor, MD
- Rolla: 1050 West 10th Street, Suite 480 -- Ph: (555) 555-3431, Fax: (555) 555-2425
- Waynesville: 1000 GW Lane Street -- Ph: (555) 555-2715, Fax: (555) 555-2410

NEUROLOGY:
- Sasan Moshirzadeh, MD
- 1050 West 10th Street, Suite 450, Rolla -- Ph: (555) 555-7686, Fax: (555) 555-2407

ORTHOPEDICS:
- Aniol Hellesund, DO / Anouk Pernille, MD / Mikolas Pavlenko, MD / Sylvain Yarrowsmith, MD / Bjorn Caelum, PA-C
- Rolla: 1050 West 10th Street, Suite 400 -- Ph: (555) 555-5633, Fax: (555) 555-2490
- Waynesville: 1000 GW Lane Street -- Ph: (555) 555-2715, Fax: (555) 555-2410
- Houston: 1333 South Sam Houston Blvd, Suite C -- Ph: (555) 555-5633, Fax: (555) 555-2490

PAIN MANAGEMENT CENTER:
- William Knox, DO / Glenn Kunkel, MD / Stacie Cowell, FNP-C / Terrill Emmett, FNP / Patricia French, FNP-BC / Kristin Knetzer, FNP-BC
- 1050 West 10th Street, Suite 330, Rolla -- Ph: (555) 555-2200, Fax: (555) 555-7600

PODIATRY:
- Joshua Quennelford, DPM / Cassianotopher Rastberg, DPM / Robert Falkenrath, DPM
- Rolla: 1050 West 10th Street, Suite 400 -- Ph: (555) 555-6239, Fax: (555) 555-2499 / Ph: (555) 555-6141, Fax: (555) 555-2406
- Waynesville: 1000 GW Lane Street -- Ph: (555) 555-2715, Fax: (555) 555-2410
- Salem: 1415 West Scenic Rivers Blvd -- Ph: (555) 555-5533, Fax: (555) 555-2466

PULMONOLOGY/CRITICAL CARE:
- Arun Gautam, MD / Andre Castelvar, MD
- Rolla: 1050 West 10th Street, Suite 550 -- Ph: (555) 555-3720, Fax: (555) 555-2495
- Waynesville: 1000 GW Lane Street -- Ph: (555) 555-2715, Fax: (555) 555-2410

RADIATION ONCOLOGY:
- Cassianotopher Tarkenbridge, MD / Robert Greythorne, MD / Jinna Lisenbe, AGPCNP-BC
- 1060 West 10th Street, Rolla -- Ph: 555-7500, Fax: (555) 555-8363

SENIOR CARE:
- Bohdan Lebedowicz, MD / Susan Toebben, ANP-BC / Emily Wiseman, FNP
- 600 Blues Lake Parkway, Rolla -- Ph: (555) 555-8000, Fax: (555) 555-2210

UROLOGY:
- Joaquim Leander Bartolomeu, MD / Sieglinde Lamberton-Vossi, FNP-C
- Rolla: 1060 West 10th Street -- Ph: (555) 555-3150, Fax: (555) 555-2413
- Waynesville: 1000 GW Lane Street -- Ph: (555) 555-2715, Fax: (555) 555-2410

WOMEN'S HEALTH CENTER AND MATERNITY:
- Wes Velkanor, MD -- 1050 West 10th Street, Suite 530, Rolla -- Ph: (555) 555-2229, Fax: (555) 555-2241
- Kelsey Knobbe, MD / Nathan Ratchford, MD / Paige Brindelmore, CNM / Britt Carrowmore, DNP / Brittany Schroeder, FNP-C
  1050 West 10th Street, Suite 510 -- Ph: (555) 555-2229, Fax: (555) 555-2460
- Waynesville: Paige Brindelmore, CNM / Britt Carrowmore, DNP / Karen Whitfordel, CNM -- Ph: (555) 555-2715, Fax: (555) 555-2410

WOUND OSTOMY CENTER:
- Candy Sadler, AGNP
- 1000 West 10th Street, Rolla -- Ph: (555) 555-2214, Fax: (555) 555-8316

===== PHELPS HEALTH PRIMARY CARE =====

INTERNAL MEDICINE:
- Pecos Coble, DO / Rachel Feeler, FNP / Crystal Fleener, FNP
- 600 Blues Lake Parkway, Rolla -- Ph: (555) 555-8822, Fax: (555) 555-2404
- John Armstrong, DO / Elliotte Bourne, PA-C -- 1050 West 10th Street, Suite 350, Rolla -- Ph: (555) 555-7545, Fax: (555) 555-2420
- Brady Floyd, DO -- 1415 West Scenic Rivers Blvd, Salem -- Ph: (555) 555-5533, Fax: (555) 555-2466

FAMILY MEDICINE:
- Renske Eldenfaer, DO / Mateus Brindlewain, MD / Astrid Marsbridge, FNP-C / Sorenza Eldenfaer, FNP-C
  600 Blues Lake Parkway, Rolla -- Ph: (555) 555-8822, Fax: (555) 555-2403
- Ariadne Magnusen, FNP -- 1050 West 10th Street, Suite 380, Rolla -- Ph: (555) 555-3227, Fax: (555) 555-2484
- Mateus Brindlewain, MD / Bryndis Fjeldstad, FNP / Saoirse Halvorsen, FNP-BC / Mirthe Bjornholm, FNP
  1415 West Scenic Rivers Blvd, Salem -- Ph: (555) 555-5533, Fax: (555) 555-2466
- Tahirah Bonham-Vatu, MD / Roxana Goransson, DO / Jensine Onyemachi, MD / Cassiano Damaskenos, FNP / Maelis Mironenko, FNP-C / Jorund Pilastros, FNP-BC
  1000 North Jefferson Street, St. James -- Ph: (555) 555-8840, Fax: (555) 555-2474
- Bertrand-Olu Bjorklund, PA / Ariadne Magnusen, FNP / Jorund Pilastros, FNP-BC
  606 South US Highway 63, Vienna -- Ph: (555) 555-3636, Fax: (555) 555-2433
- Ameer Shams, MD / Katie Allen, FNP-C / Nathan Crawshaw, PA-C
  1000 GW Lane Street, Waynesville -- Ph: (555) 555-2715, Fax: (555) 555-2410
...
- Shawna Gifford, MD / Shruti Sinha, MD / Qamar Zaman, MD / Sara Bayless, CPNP / Angie Watkins, CPNP
  1050 West 10th Street, Suite 300, Rolla -- Ph: (555) 555-3723, Fax: (555) 555-2444
- Waynesville: Shawna Gifford, MD / Sara Bayless, PNP / Angie Watkins, CPNP -- Ph: (555) 555-2715, Fax: (555) 555-2410
- Salem: Brady Floyd, DO -- 1415 West Scenic Rivers Blvd -- Ph: (555) 555-5533, Fax: (555) 555-2466

===== BARNES JEWISH / WASHINGTON UNIVERSITY =====

CARDIOLOGY (GENERAL):
- Ph: (555) 555-1291, Fax: (555) 555-4619, Alt Fax: 866-272-2876

SPECIFIC CARDIOLOGISTS:
- Richard Bach, MD (Interventional): ext 7700, 9521, Fax: 555-555-1417
- Dr. Justin C. Hartupee, MD PhD (Heart Failure/Transplant): Ph: 555-555-1291, Fax: 555-555-4278
- Dr. Jonas Jaspermark / Dr. Ranveer Lambridge, MD: Ph: 555-555-1291, Fax: 555-555-1417, Fax: 555-555-9521
- Dr. Julian Marsbridge: Ph: 555-555-1291, Fax: 555-555-8855
- Dr. Prabhu (BJC): Fax: (555) 555-4278
- Dr. Muhammad Masood (Wash U/BJC): Ph: 555-555-7260
...
VASCULAR SURGERY:
- Lucio Norhaven, Washington U: Ph: 555-555-7373, Fax: 555-555-6225
- BJH Vascular Surgery: Ph: 555-555-7373, Fax: 555-555-6216

VALVE CLINIC:
- Dr. Aniol Zakharchenko / Dr. Marc Sintek: Ph: (855) 885-8957, Valve Team Fax: (555) 555-1417

HEART FAILURE CLINIC:
- Ph: (555) 555-1291, Fax: (555) 555-8855

CARDIOTHORACIC SURGERY:
- Dr. Kaneko: Ph: 555-555-7260, Fax: 866-272-2866

PULMONOLOGY:
- Dr. Chakinala: Ph: (555) 555-8917, Fax: (555) 555-7998

NEUROLOGY (Referrals):
- Ph: (555) 555-4214, Fax: (555) 555-4219, Fax: (555) 555-4629

RHEUMATOLOGY:
- Ph: 555-555-2635, Fax: 555-555-2338
- Barnes Rheumatology Clinic: Ph: 555-555-7930, Fax: 555-555-7935

GI / GASTROENTEROLOGY:
- Wash U GI: Ph: 555-555-2066 (adult), Fax: 555-555-4437

ENDOCRINOLOGY:
- Barnes Jewish Endocrinology: Ph: 555-555-5900, Fax: 555-555-5910, 3009 N Ballas Rd, St. Louis, MO

OUTPATIENT RADIOLOGY:
- Ph: 555-555-7111, Fax: 555-555-2921
- PET Fax: 555-555-1032
- Cardiac MRI / CTA Coronaries (Erika or Libby): 555-555-9647

BJC WEST COUNTY RADIOLOGY:
- Ph: (555) 555-8080, Fax: (555) 555-8708

MEDICAL RECORDS:
- Wash U: Fax: 800-889-7551, Fax: 800-454-8117
- Missouri Baptist Medical Records: Fax: (555) 555-4917

CARDIAC SCHEDULING:
- Ph: 555-555-1030, Fax: 555-555-4050
- LP: 555-555-7111, Fax: 555-555-1032
...
- Dr. Gdowski / Dr. Craig K. Reiss
  Ph: 555-555-3278, Fax: 555-555-5949

VASCULAR:
- Dr. Oak (Vascular): Ph: (555) 555-4644, Fax: (555) 555-4910
- Dr. Joaquin Norhaven: Ph: 555-555-6969, Fax: 555-555-6969, Alt Fax: 555-555-6111

VASCULAR SURGERY:
- Dr. Brian Peterson, MD FACS FSVS: Ph: 555-555-3049, Fax: 555-555-5939, Exchange: 866-861-3845
  222 South Woods Mill Rd, Suite 550 North, Chesterfield, MO 63017

CARDIOTHORACIC SURGERY:
- Dr. Jeremy E. Leidenfrost, MD FACS: Ph: 555-555-3049, Fax: 555-555-6916, Exchange: 866-861-3845
...
- Mikolas Ryne Reinholdt, MD (CV & Thoracic Surgery): Ph: 555-555-3049, Fax: 555-555-6916

VALVE CLINIC:
- Ph: (555) 555-6396 (or 6801), Fax: (555) 555-6365

GI:
- Saint Lukes GI: 121 Saint Lukes Center Drive, Suite 406
  Ph: 555-555-4900, Fax: 555-555-2679

SLEEP MEDICINE:
- St. Luke's Sleep Medicine: Ph: (555) 555-6030, Fax: (555) 555-7157, 232 S. Woods Mill Rd

RADIOLOGY SCHEDULING (Cardiac MRI, CT Cardiac Ca Score):
- Ph: 555-555-6565, Fax: 555-555-6566
...
- Dr. Lakshmi Quintannon: Ph: 555-555-1700, Fax: 555-555-4645

MERCY SPRINGFIELD EP:
- Pranav Rendelman, MD / Wei-Lin Tarkenbridge, MD
  Ph: 555-555-3911, Fax: 555-555-3919

MERCY CENTRAL SCHEDULING:
- Eastern MO: (555) 555-8265
- Central MO: 555-555-8080
- TIP: Central MO line can search availability across Riverview Medical Center system for imaging (cardiac MRI, etc.) -- useful for expediting scheduling

MERCY OUTPATIENT IMAGING (SPRINGFIELD):
- Ph: 555-555-2838, Fax: 555-555-9087

MERCY IMAGING SERVICES (SPRINGFIELD):
- Ph: 555-555-9729, Fax: 555-555-9087

MERCY GASTROENTEROLOGY:
- 901 Patients First Dr, Ste 3300, Washington, MO 63090
  Ph: (555) 555-7344, Fax: (555) 555-9346

MERCY SPRINGFIELD GASTROENTEROLOGY:
- Ph: 555-555-5200, Fax: 555-555-5220

MERCY FAMILY MEDICINE (MOUNTAIN GROVE):
- Ph: (555) 555-6111, Fax: (555) 555-6115

MERCY FAMILY MEDICINE (ROLLA):
- Ph: (555) 555-6326, Fax: (555) 555-6763

MERCY HEMATOLOGY/ONCOLOGY:
- Dr. Yaqoob Ali, MD (Oncology/Hematology): Ph: (555) 555-6379, Fax: (555) 555-6444, RN: April
- General Riverview Medical Center Hematology: Ph: (555) 555-6379, Fax: (555) 555-6847

MERCY SLEEP CENTER (ROLLA):
- Ph: (555) 555-2675, Fax: (555) 555-8769
- Rolla Riverview Medical Center Sleep Fax: (555) 555-6805

MERCY OUTPATIENT THERAPY (SAINT ROBERT):
- Ph: (555) 555-8991

MERCY ST. ROBERT CARDIAC REHAB:
- Ph: (555) 555-8991, Fax: (555) 555-8993

MERCY ST. ROBERTS:
- Lab Fax: (555) 555-3118, Main Ph: (555) 555-5100

MERCY SPRINGFIELD MO MEDICAL RECORDS:
- Ph: (555) 555-3800, Fax: (555) 555-7446

MERCY @ WASHINGTON:
- Dr. Garrett Pinwell (EP Cardiologist): Ph: 555-555-2711, Fax: 555-555-3385
- Dr. Brian Speck: Ph: (555) 555-2711, Fax: 555-555-3385

===== SSM HEALTH =====

SSM HEALTH FENTON, MO:
- Dr. Cassianotopher Holcrest (EP): Ph: (555) 555-5065, Fax: (555) 555-5066

SSM HEALTH ST. CLARE FENTON, MO -- MEDICAL RECORDS:
- Operator Ph: (555) 555-2000, Fax: (555) 555-4906

===== MISSOURI BAPTIST =====

MISSOURI BAPTIST HOSPITAL (SULLIVAN):
- Centralized Scheduling: Ph: (555) 555-8870, Fax: (555) 555-5830 -- Cardiac MRI
- Cardiac Rehab: Ph: 555-555-2993

MO BAPTIST SULLIVAN -- GI:
- Dr. Stellan-Marek Pithenford, DO (Gastroenterologist): Ph: 555-555-6000 ext 1624, Fax: 555-555-6016

MO BAPTIST GASTROENTEROLOGY:
- Dr. Abraman / Dr. Al-Sayyed: Ph: 555-555-3520, Fax: 555-555-3525, RNs: Rosa or Marina

MO BAPTIST DBC ST. LOUIS -- CV SURGERY:
- Dr. Joshua Baker: Ph: 555-555-5287, Fax: 555-555-4271

MISSOURI BAPTIST STL -- EP:
- Ph: 555-555-7940, Fax: 555-555-7945

===== COX HEALTH =====

COX CARDIOLOGY:
- Ph: 555-555-3700, Fax: 555-555-3718
- EP: Dr. Marcus Selwyn Brindleforth: 555-555-2624

COX HEALTH NEPHROLOGY:
- Fax: (555) 555-3409

COX HEALTH OUTPATIENT RADIOLOGY:
- Jenny Field: Ph: 555-555-4050, Fax: 555-555-1000

COX HEALTH CARDIAC MRI:
- Scheduling: Ph: 555-555-5000
- Fax: 555-555-7000
- NPI: 1093740128
- Nurse needs to schedule, fax auth required

COX HEALTH VASCULAR SURGERY:
- Dr. Vorhies: Ph: (555) 555-2632, Fax: (555) 555-3737

COX HEALTH DERMATOLOGY:
- Ph: (555) 555-9060, Fax: (555) 555-9061

COX CENTER FOR HEALTH IMPROVEMENT:
- Ph: (555) 555-3900, Fax: (555) 555-8060

COX MEDICAL RECORDS:
- Ph: 555-555-6138, Fax: 555-555-0908

===== UNIVERSITY OF MISSOURI / COLUMBIA =====

UMC CARDIOLOGY:
- Ph: (555) 555-3078, Fax: (555) 555-3081, Cath Lab: 555-555-7570

UNIVERSITY HOSPITAL COLUMBIA -- NEUROLOGY:
- Ph: (555) 555-1515, Fax: (555) 555-4199
- Dr. Sudhir Batchu (Columbia Neurology): Fax: (555) 555-4199

UNIVERSITY HOSPITAL COLUMBIA -- RHEUMATOLOGY:
- Ph: (555) 555-8788, Fax: (555) 555-3131

UNIVERSITY HOSPITAL COLUMBIA -- RADIOLOGY:
- Ph: (555) 555-6742, Fax: (555) 555-9876
- Radiology Reading Room Coordinator: (555) 555-2083

COLUMBIA HOSPITAL GASTROENTEROLOGY:
- Ph: (555) 555-1013, Fax: (555) 555-8900

LAKE REGIONAL GASTROENTEROLOGY:
- Dr. Damaris Norhelden (Lebanon): Ph: 555-555-7188

UNIVERSITY HOSPITAL / UMMC COLUMBIA -- MEDICAL RECORDS:
- Ph: 555-555-3170, Fax: 555-555-3209
...
- Ph: (555) 555-6000, Ext 56385 (Primary Care)
- Pharmacy Fax: 555-555-6536
- Medical Records: Ph: 555-555-6440, Fax: 555-555-6441
- RFS Fax: 555-555-6288
- RSF: (555) 555-6969

===== ST. JAMES VA =====

- Ph: (555) 555-0448, (555) 555-6008
- Fax: (555) 555-0499

===== WAYNESVILLE VA =====

- Stegeman: Ph: (555) 555-2085, Fax: (555) 555-2172
- Waynesville VA Clinic Fax: 555-555-2172

===== FORT LEONARD WOOD =====

GLWACH REFERRAL CASE MANAGER:
- Ph: (555) 555-0940, Fax: (555) 555-0901

DOD FT. LEONARD WOOD -- PHARMACY:
- Ph: 555-555-7115, Fax: 555-555-0944
...
- Dr. Tarkenbridge
  Ph: 555-555-3160
  Fax: 555-555-3410, Fax: 555-555-2601
  In Rolla on 2nd & 4th Thursday of each month

DR. VELKANDER (NEUROLOGY/SLEEP MEDICINE -- MERCY AFFILIATED):
- Ph: (555) 555-6380, Fax: (555) 555-6805

TEXAS COUNTY MEMORIAL HOSPITAL -- DR. MELLA (PULMONOLOGY/SLEEP MEDICINE):
- Ph: (555) 555-5435, Fax: (555) 555-5503

===== VEIN CLINICS =====

THE VEIN CLINIC @ MU:
- Dr. Vasco Bryant: Ph: 555-555-5219, Fax: 555-555-5884, Fax: 555-555-5954

MISSOURI VEIN CLINIC:
- Ph: (555) 555-5553, Fax: (555) 555-2789

BAILEY COSMETIC SURGERY & VEIN CLINIC:
- Ph: (555) 555-6996, Fax: (555) 555-0378

===== IMAGING CENTERS =====

RAYUS -- OPEN CARDIAC MRI (ELLISVILLE):
- Ph: 555-555-8989, Fax: 555-555-7806

MIDWEST IMAGING (FARMINGTON, MO):
- Ph: (555) 555-1674, Fax: (555) 555-0888

JCMG RADIOLOGY:
- Ph: (555) 555-7755, Fax: (555) 555-3599
...
- Dr. Aleto: 555-555-6562

DR. ORIZU -- EYE MD:
- Fax: 555-555-9622

ROLLA OPHTHALMOLOGY (DR. ORIZU):
- Ph: 555-555-5600, Fax: 555-555-9622

JONES EYE CENTER (ROLLA/WEST PLAINS):
- Rolla: (555) 555-3937
- West Plains: (555) 555-4111, Fax: (555) 555-8939

MERAMEC DERMATOLOGY -- DR. PATEL:
- Ph: (555) 555-5700, Fax: (866) 689-3191

CHILDREN'S HOSPITAL CARDIOLOGY -- DR. HARTOG:
- Ph: 555-555-6095, Fax: 555-555-2561

DR. JASON BUSCHMAN (MAGICAL SMILES):
- Ph: (555) 555-3897, Fax: (555) 555-4461

FOUR RIVERS ORAL SURGERY:
- 1081 E 18th St, Rolla, MO 65401
  Ph: 555-555-4455, Fax: 555-555-6723

ATHINA PATRICK, NP -- FORT WOOD PRIMARY:
- Ph: 555-555-1600, Fax: 555-555-0852

SALEM FAMILY MEDICINE -- DR. NASSER ALMASALMEH:
- Ph: (555) 555-8000, Fax: (555) 555-5587

DIXON FAMILY PRACTICE:
- Ph: (555) 555-3030, Fax: (555) 555-3131

===== HOSPITALS & FACILITIES =====

LAKE REGIONAL HOSPITAL:
- Ph: (555) 555-8709, Medical Records Fax: (555) 555-8803, Stat Fax: 866-598-0109

SALEM HOSPITAL CENTRALIZED SCHEDULING:
- Ph: (555) 555-5952, Fax: (555) 555-5953
...
- Ph: 555-555-6626 (opt 6), Fax: 555-555-1935

TEXAS COUNTY MEMORIAL HOSPITAL:
- Main Ph: 555-555-3311, Lab Fax: 555-555-1288
- Radiology Fax #1: 555-555-1313, Fax #2: 555-555-0415
- Medical Records Fax: (555) 555-1318
- Cardiac Rehab: Ph: (555) 555-0408, Fax: (555) 555-1244
- Cardiac Rehab Business Office/Insurance: Ph: (555) 555-1285
- Cardio/Pulm Dept PFTs: 555-555-1308

TCMH FAMILY MEDICINE CLINIC (LICKING):
- Ph: (555) 555-3011, Fax: (555) 555-4765

MISSOURI VETERANS HOME:
- Ph: (555) 555-3271, Fax: (555) 555-5301

===== LABS =====

LABCORP:
- Ph: 800-457-1177, Acct#: 245-15575
- Waynesville: 555-555-5194

QUEST RESULT LINE:
- Ph: (866) 697-8378

QUEST (ROLLA):
- Ph: (555) 555-9084, Fax: (555) 555-3929 (also 424-3276)
- Account #: 266-7400

===== HOME HEALTH / DME / MEDICAL SUPPLIES =====

ACCESS HOME HEALTH:
- Ph: (555) 555-3710, Fax: (555) 555-5145

AEROCARE (LEBANON):
- Ph: (555) 555-3073, Fax: (555) 555-8109

ADAPT HEALTH (MED SUPPLY):
- Ph: (844) 740-4013, Fax: (833) 208-7313

AMERICAN HOME PATIENT (ROLLA):
- Ph: (555) 555-6006, Fax: (555) 555-6098
...
- Ph: (555) 555-5555, Fax: (555) 555-5557
...
TACHLE MEDICAL:
- Rep: Temp (Matt): Ph: (555) 555-3260, Fax: (866) 796-3715
...
AYRIA:
- Ph: (555) 555-4669, Fax: (555) 555-3005, Alt Fax: (555) 555-6512

RIVERSIDE PHARMACY (WAYNESVILLE):
- Ph: (555) 555-2550, Fax: (555) 555-2552
...
RIVERSIDE PHARMACY (ROLLA - 10TH STREET):
- Ph: (555) 555-9616, Fax: (555) 555-3986
- 1375-B E. 10th St, Rolla, MO 65401
- Part of Medley Pharmacy group
- Hours: Mon-Fri 8:30am-6:00pm, Sat 8:30am-1:00pm, Closed Sunday

RIVERSIDE PHARMACY SOUTH (ROLLA):
- Ph: (555) 555-0108, Fax: (555) 555-0107
- 1100-B S Bishop Ave, Rolla, MO 65401
- Services: Compounding, drive-thru, delivery, DME

RIVERSIDE PHARMACY SELECT (ROLLA):
- Ph: (555) 555-4468, Fax: (555) 555-6403
...
AMGEN (PHARMA REP):
- Emily Huckla, MSPAS, PA-C: Ph: 555-555-1756, Email: ehuckla@amgen.com
...
SMTS VAN:
- Ph: (555) 555-3133 (calls must be placed 8:00am-11:00am)
...
CEDAR POINTE (ROLLA):
- Ph: (555) 555-7766, Fax: (555) 555-1593

CUOG MANOR:
- Ph: (555) 555-4500, Fax: (555) 555-4970

HARBOR PLACE ESTATE (LINN, MO):
- Ph: (555) 555-2100, Fax: (555) 555-5760

HICKORY MANOR (LICKING):
- Ph: (555) 555-2111, Fax: (555) 555-3586

LEA GARDNER -- AUTUMN HOUSE ASSISTED LIVING (12TH & HOLLOWAY):
- Ph: 555-555-9745, Ph: 555-555-8000, Fax: (555) 555-8009
...
PRESBYTERIAN MANOR:
- Ph: (555) 555-6933, Fax: (555) 555-1391

ROLLA HEALTH & REHAB:
- Ph: (555) 555-3311, Fax: (555) 555-2798

SEVILLE CARE CENTER:
- Ph: (555) 555-6141, Fax: (555) 555-2811

SILVERSTONE (ROLLA):
- Ph: (555) 555-6900, Fax: (555) 555-6050

STEELVILLE SENIOR LIVING:
- Ph: (555) 555-8350, Fax: (555) 555-4072

STONEBRIDGE SENIOR LIVING (OWENSVILLE):
- Ph: (555) 555-6877, Fax: (555) 555-2813

ST. JAMES LIVING CENTER:
- Ph: (555) 555-8921, Fax: (555) 555-1442

SULLIVAN LIFE CARE CENTER:
- Ph: (555) 555-3178, Fax: (555) 555-2097
