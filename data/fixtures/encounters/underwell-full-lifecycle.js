...
// Reed (Davis) BP/amlodipine — call → 16-question chart-aware
  ...
  actionScripts: {
    ...
    "synthesize-callback": [
      ...
      },
      {
        ...
        delayMsBefore: 400,
        content:
          "Mrs. Reed, this is Brandon from the Cardiology Associates, calling back with what Dr. Davis wants to do next.\n\nFirst, the plan: stop amlodipine completely. Continue carvedilol, spironolactone, and Jardiance exactly as you have been taking them.\n\nA few things for context. Your BNP from April 1st was normal at 200, which is reassuring on the heart-failure side. Dr. Davis has a Holter monitor lined up for you to keep an eye on your heart rhythm now that the carvedilol is at the new dose.\n\nWhat I will need from you: keep your home blood pressure log for one more week after stopping amlodipine, and let us know if the swelling gets better or worse over the same week.\n\nIf the readings come back uncontrolled, Dr. Davis may swap to a different blood pressure medication. We will not be making that decision today — we want to see what your numbers do without amlodipine first.\n\nDo you have any questions?",
      },
          ...
          orders: [
            {
              ...
              cosign: "Davis",
              auditTrail: "discontinuing per Davis after SBAR review and provider authorization",
            },
            {
