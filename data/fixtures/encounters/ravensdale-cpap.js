...
// Source: docs/KAIROS-SESSION-2026-04-29-AFTERNOON.md CASE 18 (Morris/Thompson)
  ...
  actionScripts: {
    "generate-note-mychart": [
      ...
      },
      {
        ...
        delayMsBefore: 400,
        content:
          "Mr Thompson,\n\nDr. Davis has reviewed your sleep study. The results show moderate-to-severe sleep apnea, which is treatable with a CPAP machine.\n\nWe have placed the CPAP order with Apria (the supplier). They will reach out to schedule a setup. Dr. Davis has also referred you to sleep medicine for ongoing management of the apnea — they will contact you to schedule.\n\nPlease let us know if you have not heard from Apria within 7-10 business days.\n\nBrandon Sterne, RN BSN / Cardiology Associates",
      },
