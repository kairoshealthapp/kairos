...
const fixture = {
  ...
  patient: {
    ...
    mrn: "82110649",
    proxyName: null,
    primary: "Marchetti, Cardiology (Coumadin Clinic)",
  ...
  actionScripts: {
    "forward-to-provider": [
      ...
      { type: "banner", kind: "red", text: "Contradiction detected: patient statement vs active medication list. Holding all autonomous action.", durationMs: 1400 },
      {
        ...
        delayMsBefore: 500,
        content:
          "CHART CONTRADICTION FLAG — DO NOT REPLY AUTONOMOUSLY.\n\nPatient replied to outbound INR overdue MyChart template (sent 4/24). Patient states Dr. M (Marchetti) discontinued warfarin and INR monitoring.\n\nChart state at time of message:\n  - Med list: warfarin 6mg daily ACTIVE\n  - Last provider note: 4/21/2026 — no documentation of discontinuation\n  - Last INR: 4/19, therapeutic\n  - Coumadin Clinic still scheduled\n\nForwarded to Marchetti for verification before any patient-facing reply. No MyChart message drafted. No order changes.",
      },
      { type: "banner", kind: "red", text: "Forwarded to Marchetti — awaiting provider confirmation", durationMs: 1200, delayMsBefore: 300 },
      { type: "state-transition", target: "card", newState: "drafted", delayMsBefore: 200 },
    ],
  },
  finalSignedState: {
    nurseNote:
      "Patient replied to outbound INR overdue MyChart template (4/24). Patient states Dr. M discontinued warfarin + INR monitoring. CHART CONTRADICTION: med list still shows active warfarin, no recent provider note documenting discontinuation. Forwarded to Marchetti for verification — NO autonomous action.",
