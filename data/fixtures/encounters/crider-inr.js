...
// Source: real Demirci INR review (2026-04-30, Phelps Lab). Demonstrates
...
const fixture = {
  ...
  patient: {
    name: "Demirci, Kallista J.",
    displayName: "Kallista J. Demirci",
    age: 72,
    sex: "F",
    dob: "1953-07-04",
    mrn: "M000060536",
    proxyName: null,
    primary: "Mateus Espinosa, MD (PCP)",
    cardiologyCoverage: "Rashid H. Sokolov, MD",
  ...
  pendedOrders: false,
  nextAppt: "Cardiology with Rashid H. Sokolov, MD — 5/4/2026 4:00 PM",
  initialPaneContent: {
    nurseNote: "",
    mychartMessage: "",
    phoneScript: "",
  ...
  finalSignedState: {
    nurseNote:
      "PROTIME-INR 2.0 (PT 23.0s, Phelps Lab, drawn 11:57, resulted 13:32). Within target 2.0–3.0 for atrial fibrillation with RVR on conventional anticoagulation. Trend over four months: 2.5 → 2.7 → 2.5 → 2.3 → 2.0 — drift toward lower bound but still in range. No dose change indicated. Continue current warfarin regimen. Next cardiology visit Dr. Sokolov 5/4/2026 16:00.",
    phoneScript: "",
    orders: [],
