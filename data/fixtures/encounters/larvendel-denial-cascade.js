...
const fixture = {
  ...
  authState: {
    ...
    chain: [
      { date: "2026-04-02", event: "NM SPECT ordered by Pendrelle", state: "ORDERED" },
      { date: "2026-04-21 10:24", event: "DENIED #1 — Homestate Health, Evolent guideline 7312 (need stress echo first)", state: "DENIED" },
      { date: "2026-04-21 12:32", event: "Pendrelle alt: stress echocardiogram if patient can exercise", state: "ALT_PROPOSED" },
      { date: "2026-04-21 13:13", event: "Patient unable to walk — chest pain on movement", state: "ALT_BLOCKED" },
      { date: "2026-04-21 13:19", event: "Pendrelle alt: Lexiscan Myoview stress test", state: "ALT_PROPOSED" },
      { date: "2026-04-24 07:53", event: "Lexiscan cancelled per Pendrelle; CTA Coronary ordered instead", state: "ALT_REPLACED" },
  ...
  sourceArtifact: {
    ...
    messages: [
      ...
      },
      {
        ...
        text: "Per Pendrelle, Lexiscan Myoview cancelled. Pre-cert appeal also cancelled. Coronary CT angiogram ordered given symptoms of chest pain, SOB, nausea, and diaphoresis with known CAD s/p PCI with stenting.",
      },
      {
