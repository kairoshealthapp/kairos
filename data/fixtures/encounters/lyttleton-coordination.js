...
// Source: docs/KAIROS-SESSION-2026-04-29.md Section 6 (Patton/Lyttleton)
...
const fixture = {
  ...
  patient: {
    name: "Lyttleton, Augustus",
    displayName: "Augustus Lyttleton",
    age: 66,
    sex: "M",
    dob: "1960-01-15",
    mrn: "29014731",
  ...
  sourceArtifact: {
    type: "Patient Call",
    author: "Patient (via clinic phone, routed by front desk Adelaide Crowley)",
  ...
  finalSignedState: {
    nurseNote:
      "Patient called re: (1) earlier EP appointment alternative; (2) albuterol refill. HVC referral directory queried — alternates Vellacott + Birchington same Wash U group. Forwarded scheduling preferences to Dr. Loxley.",
    phoneScript:
      "Mr. Lyttleton, returning your call — alternates available at the same Wash U group; will follow up by end of day. Refill sent.",
