...
// Phillips DOE 4 stents 2025 — 20 chart-aware questions, MRSA discovery via Q16.
...
const fixture = {
  ...
  patient: {
    name: "Phillips, Calliope",
    displayName: "Calliope Phillips",
    age: 78,
    sex: "M",
    dob: "1948-04-01",
    mrn: "82091736",
  ...
  finalSignedState: {
    nurseNote:
      "Patient reports DOE despite 4 stents 2025. 20 chart-aware questions deployed (canonical pattern-7 implementation). Surprise data: active MRSA infection from elbow surgery (caught via medication-list cross-check), decreased appetite, weight loss. SBAR forwarded to Loxley urgent.",
