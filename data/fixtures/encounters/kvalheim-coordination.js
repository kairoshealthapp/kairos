...
const fixture = {
  ...
  finalSignedState: {
    nurseNote:
      "Patient called re: (1) earlier EP appointment alternative; (2) albuterol refill. HVC referral directory queried — alternates Inwarden-Linder + Yagami same Wash U group. Forwarded scheduling preferences to Dr. Voronova.",
    phoneScript:
