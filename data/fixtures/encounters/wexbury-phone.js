...
// Source: docs/KAIROS-SESSION-2026-04-29-EVENING.md CASE 27 (Ramey/Wexbury)
...
const fixture = {
  ...
  patient: {
    name: "Wexbury, Henrietta",
    displayName: "Henrietta Wexbury",
    age: 83,
    sex: "F",
    dob: "1943-04-02",
    mrn: "30816401",
  ...
  actionScripts: {
    ...
    "generate-voicemail": [
      { type: "banner", kind: "green", text: "Drafting voicemail variant (~30-45s spoken)…", durationMs: 700 },
      {
        ...
        delayMsBefore: 400,
        content:
          "\n\n— VOICEMAIL VARIANT —\n\nHi Mrs. Wexbury, this is Brandon from the Heart and Vascular Clinic, calling about the results of your recent echocardiogram. Dr. Beckweldon has reviewed the test and the news is reassuring — your heart's pumping function is normal and there are no medication changes. Please give us a call back at the clinic number when you have a moment so we can review the details with you. Thank you.",
      },
    ],
  },
  finalSignedState: {
