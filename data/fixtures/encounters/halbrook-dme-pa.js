  ...
  actionScripts: {
    "generate-reply": [
      ...
      { type: "banner", kind: "yellow", text: "Workflow Playbook Library: NEW playbook \"DME PA — dual-eligible Medicare/MO HealthNet\" being captured…", durationMs: 1800 },
      {
        ...
        delayMsBefore: 500,
        content:
          "DME prior auth — Apria CPAP for Halbrook (dual-eligible Medicare A+B + MO HealthNet). Per Apria, PA path is a phone call to MO HealthNet (NOT a form). Three data points needed: ICD-10 (G47.33 OSA), AHI (from sleep study report 1/2026: 22.4), NPI (Loxley 1234567890). Called MO HealthNet PA line, approval # = patient's MO HealthNet member ID. Faxed approval back to Apria for processing. Patient outreach below.\n\nPlaybook captured in Workflow Playbook Library — auto-attaches to next dual-eligible DME PA card for any nurse.",
      },
      {
        type: "pane-update",
        target: "mychart",
