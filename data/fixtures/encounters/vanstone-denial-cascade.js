...
// Source: docs/KAIROS-SESSION-2026-04-29-EVENING.md CASE 25+26 (Brown/Vanstone)
...
const fixture = {
  id: "vanstone-denial-cascade",
  slug: "vanstone-denial-cascade",
  patternId: 13,
  ...
  patient: {
    name: "Vanstone, Carol N",
    displayName: "Carol N Vanstone",
    age: 41,
    sex: "F",
    dob: "1985-06-18",
    mrn: "94817302",
    proxyName: null,
    primary: "Adler J Townsend, FNP-BC",
  ...
  authState: {
    ...
    chain: [
      { date: "2026-04-02", event: "NM SPECT ordered by Loxley", state: "ORDERED" },
      { date: "2026-04-21 10:24", event: "DENIED #1 — Homestate Health, Evolent guideline 7312 (need stress echo first)", state: "DENIED" },
      { date: "2026-04-21 12:32", event: "Loxley alt: stress echocardiogram if patient can exercise", state: "ALT_PROPOSED" },
      { date: "2026-04-21 13:13", event: "Patient unable to walk — chest pain on movement", state: "ALT_BLOCKED" },
      { date: "2026-04-21 13:19", event: "Loxley alt: Lexiscan Myoview stress test", state: "ALT_PROPOSED" },
      { date: "2026-04-24 07:53", event: "Lexiscan cancelled per Loxley; CTA Coronary ordered instead", state: "ALT_REPLACED" },
  ...
  sourceArtifact: {
    ...
    body:
      "CTA Coronary Arteries denied. Reason: missing a doctor's note explaining why a heart-walking test (Stress Echocardiogram) cannot be done. A peer-to-peer is available today only by calling 800-XXX-XXXX (Member ID# 16337356, Tracking# 098121753502). Resubmission with new documentation also possible. — Leona Petrov (8789)\n\n[Roland P Loxley, NP added to thread 14:33. Brandon: \"Mr Loxley, FYI\" + thumbs-up reaction.]",
    threadHistory: [
      { at: "2026-04-21 10:24", from: "Genevieve Strathmore (PHS)", text: "Homestate Health denied NM SPECT per Evolent Clinical Guideline 7312, requesting documentation of medical necessity for why exercise stress echo cannot be performed instead." },
      { at: "2026-04-21 12:32", from: "Loxley", text: "If the patient can exercise, can change to a stress echocardiogram." },
      ...
      { at: "2026-04-21 13:19", from: "Loxley", text: "Given the patient's inability to walk on a treadmill, would recommend Lexiscan Myoview stress test for further evaluation." },
      { at: "2026-04-24 07:53", from: "Brandon Sterne, RN BSN", text: "Per Loxley, Lexiscan Myoview cancelled. Pre-cert appeal also cancelled. Coronary CT angiogram ordered given symptoms of chest pain, SOB, nausea, and diaphoresis with known CAD s/p PCI with stenting." },
  ...
  actionScripts: {
    "generate-denial-aware-outreach": [
      ...
      { type: "banner", kind: "yellow", text: "Auth-state detected: DENIAL_CASCADE active. Switching to denial-acknowledgment frame.", durationMs: 1800 },
      {
        ...
        delayMsBefore: 500,
        content:
          "Pattern 13 INSURANCE DENIAL CASCADE — second denial in 8-day investigation. Dr. Loxley added to Secure Chat thread for peer-to-peer decision (deadline today only) vs. resubmission vs. moving directly to heart cath given patient's CAD with prior stent + ongoing symptoms.\n\nPatient outreach drafted using denial-acknowledgment frame (NOT default imaging-review frame — auth-state aware). Voicemail attempted concurrently with MyChart send.",
      },
      {
        type: "pane-update",
        target: "mychart",
