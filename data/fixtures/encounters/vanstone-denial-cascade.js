...
// Source: docs/KAIROS-SESSION-2026-04-29-EVENING.md CASE 25+26 (Brown/Jackson)
...
const fixture = {
  ...
  patient: {
    name: "Jackson, Tanya N.",
    displayName: "Tanya N. Jackson",
    age: 41,
    sex: "F",
    dob: "1985-06-18",
    mrn: "94817302",
    proxyName: null,
    primary: "Atticus J Robinson, FNP-BC",
  ...
  authState: {
    ...
    chain: [
      { date: "2026-04-02", event: "NM SPECT ordered by Davis", state: "ORDERED" },
      { date: "2026-04-21 10:24", event: "DENIED #1 — Homestate Health, Evolent guideline 7312 (need stress echo first)", state: "DENIED" },
      { date: "2026-04-21 12:32", event: "Davis alt: stress echocardiogram if patient can exercise", state: "ALT_PROPOSED" },
      { date: "2026-04-21 13:13", event: "Patient unable to walk — chest pain on movement", state: "ALT_BLOCKED" },
      { date: "2026-04-21 13:19", event: "Davis alt: Lexiscan Myoview stress test", state: "ALT_PROPOSED" },
      { date: "2026-04-24 07:53", event: "Lexiscan cancelled per Davis; CTA Coronary ordered instead", state: "ALT_REPLACED" },
  ...
  sourceArtifact: {
    ...
    messages: [
      {
        sender: "Christine Bell",
        role: "Lakeside Cardiology Support Pool",
      ...
      },
      {
        ...
        text: "Per Davis, Lexiscan Myoview cancelled. Pre-cert appeal also cancelled. Coronary CT angiogram ordered given symptoms of chest pain, SOB, nausea, and diaphoresis with known CAD s/p PCI with stenting.",
      },
      {
        sender: "Amanda Wright",
        role: "Lakeside Cardiology Support Pool",
  ...
  actionScripts: {
    "generate-denial-aware-outreach": [
      ...
      { type: "banner", kind: "yellow", text: "Auth-state detected: DENIAL_CASCADE active. Switching to denial-acknowledgment frame.", durationMs: 1800 },
      {
        ...
        delayMsBefore: 500,
        content:
          "Second denial in 8-day workup. Dr. Davis looped into Secure Chat for peer-to-peer decision (deadline today only) vs. resubmission vs. moving directly to heart cath given patient's CAD with prior stent and ongoing symptoms.\n\nPatient outreach drafted in denial-acknowledgment frame rather than routine imaging-review frame. Voicemail attempted concurrently with MyChart send.",
      },
      {
        type: "pane-update",
        target: "mychart",
