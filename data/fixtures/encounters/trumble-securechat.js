...
// Source: docs/KAIROS-SESSION-2026-04-29-AFTERNOON.md CASE 20 (Bailey/Trumble)

const fixture = {
  id: "trumble-securechat",
  slug: "trumble-securechat",
  patternId: 10,
  ...
  patient: {
    name: "Trumble, Wendell",
    displayName: "Wendell Trumble",
    age: 69,
    sex: "M",
    dob: "1957-04-01",
    mrn: "73018241",
  ...
  finalSignedState: {
    nurseNote:
      "Stale referral identified. Loxley confirms still clinically relevant. Patient outreach scheduled. Thread-state synchronization will close the originating Secure Chat thread automatically once patient acknowledges.",
