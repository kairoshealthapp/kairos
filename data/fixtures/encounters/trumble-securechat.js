...
const fixture = {
  ...
  sourceArtifact: {
    ...
    author: "Linda Cooper (PHS scheduling, 9:20 AM)",
  ...
  finalSignedState: {
    nurseNote:
      "Stale referral identified. Davis confirms still clinically relevant. Patient outreach scheduled. Thread-state synchronization will close the originating Secure Chat thread automatically once patient acknowledges.",
