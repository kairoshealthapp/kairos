...
const fixture = {
  ...
  finalSignedState: {
    nurseNote:
      "Dr. Pendrelle reviewed Chem-8 (unremarkable), Magnesium 1.6 (low — start OTC supplement), H&H mildly elevated (similar to 7/2025) — refer to hematology. Patient notified via MyChart.",
    mychartMessage:
