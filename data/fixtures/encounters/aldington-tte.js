...
const fixture = {
  ...
  actionScripts: {
    "generate-note-mychart": [
      ...
      },
      {
        ...
        delayMsBefore: 600,
        content:
          "Dr. Beckweldon reviewed CTA chest from this week. Findings consistent with mild aortic stenosis and mild aortic regurgitation, possible bicuspid aortic valve. TTE ordered for reassessment of valve morphology and severity. No medication changes. Patient to follow up at next routine visit if asymptomatic, sooner if symptomatic.\n\nPatient notified via MyChart. Patient's daughter (Tamara Joy Aldington, MyChart proxy) auto-included.",
      },
      {
        type: "pane-update",
        target: "mychart",
  ...
  finalSignedState: {
    nurseNote:
      "Dr. Beckweldon reviewed CTA chest. Mild AS, mild AR, possible bicuspid AV. TTE ordered for reassessment. No med changes. Patient notified via MyChart.",
    mychartMessage: "[As drafted above]",
    orders: [
      "Transthoracic echo (TTE) Complete — ECH110 STERNE BR — Future 4/29 First Available — Routine — Beckweldon cosign",
    ],
