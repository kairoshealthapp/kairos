  ...
  actionScripts: {
    "generate-note-mychart": [
      ...
      },
      {
        ...
        delayMsBefore: 500,
        content:
          "Dr. Davis reviewed lipid panel today. LDL 67 (at goal), HDL 41 (slightly below goal), triglycerides 182 (slightly above goal), total cholesterol 139 (at goal). No medication change. Continue current statin. Lifestyle counseling provided in patient message.\n\nPatient notified via MyChart.",
      },
      {
        type: "pane-update",
        target: "mychart",
