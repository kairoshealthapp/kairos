...
const fixture = {
  ...
  referralPacket: {
    ...
    coverLetter: {
      ...
      preview: "Re: Kevin Morris, DOB 5/30/1958, MRN 70019384. Sleep study performed [date], AHI 28.6 consistent with moderate-to-severe OSA. CPAP therapy ordered. See attached: face sheet, insurance card, photo ID, sleep study report, recent cardiology note. Please confirm receipt and contact patient within 3-5 business days. — R. P. Davis, NP",
    },
    items: {
      faceSheet: { included: true, source: "Patient demographics + insurance + MRN", auto: true },
      clinicalDocumentation: [
        { name: "Davis result note 4/29/2026", source: "Notes → Office Visit", included: true, auto: true, rationale: "Referring encounter — required" },
