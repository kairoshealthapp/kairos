...
const TOUR_SCRIPT = [
  ...
  // FIXTURE 4 — Stewart transactional (Pattern 9)
  {
    ...
    preArrivalNarrator: {
      ...
      deepVoiceText:
        "Mr. Stewart, sixty-five. Coumadin Clinic patient. Nine days ago his I-N-R ran three-point-nine — supratherapeutic — and Reynolds dropped his warfarin from six-point-five milligrams to six. Today he replied asking for the refill. The Rx Request box is full of these — same rule, same shape, fifty times a shift.",
  ...
  // FIXTURE 6 — Foster contradiction (Pattern 8)
  {
    ...
    preArrivalNarrator: {
      ...
      quickVoiceText:
        "Mr. Foster, seventy-four. Coumadin Clinic patient — RN-protocol-driven. Normally Kairos drafts the dose, the RN authorizes per protocol. But today he replied: Dr. H told me to stop warfarin and the blood test. Chart shows warfarin active. No provider note discontinuing it. The rare card that exits protocol.",
      deepVoiceText:
        "Mr. Foster, seventy-four. Coumadin Clinic patient. The Coumadin Clinic here is RN-protocol-driven — the RN runs the protocol, makes dose adjustments per established criteria, signs them off without provider involvement. Provider only gets pulled in for the rare clarification case — usually whether a patient should be on coumadin at all. Five days ago his I-N-R was therapeutic on six milligrams of warfarin — his dose for months. The I-N-R overdue MyChart template went out four days ago because he'd missed his routine check. Today he replied: Dr. H told me to be taking only the other two medications, and also said I don't have to take the blood test anymore. Chart shows warfarin active. No provider note documenting any discontinuation. The rare card — the on-or-off-coumadin question the protocol can't answer alone.",
    ...
    onAuthorize: {
      ...
      quickVoiceText:
        "Coumadin Clinic stays RN-protocol-driven. Kairos drafts the dose, RN authorizes, provider doesn't see it. Provider gets pulled in only for on-or-off — the question this card raised. Kairos noticed. The contradiction is the output, not a reply.",
      deepVoiceText:
