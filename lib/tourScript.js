...
const TOUR_SCRIPT = [
  ...
  // FIXTURE 2 — Wood lipid (Pattern 1)
  {
    ...
    onArrival: {
      ...
      quickVoiceText:
        "L-D-L at goal, H-D-L slightly below, triglycerides slightly elevated. Loxley isn't changing meds — wants the patient educated on lifestyle. In pure Epic, this gets written from scratch every time, with phrasing that drifts shift to shift.",
      deepVoiceText:
  ...
  // FIXTURE 3 — Calderwood Crestor (Pattern 4)
  {
    ...
    preArrivalNarrator: {
      ...
      deepVoiceText:
        "Ms. Calderwood, fifty-nine. Lipid panel and chem-eight reviewed. L-D-L one-forty-two, above goal. Dr. Loxley wants Crestor uptitrated — twenty milligrams to forty — and a lipid panel plus hepatic function panel rechecked together in ninety days. In pure Epic, this card is roughly fourteen discrete actions. Watch.",
        ...
        annotations: [
          {
            ...
            quickVoiceText:
              "Discontinue Crestor twenty, place Crestor forty. Audit-trail note populates from the plan — increasing to forty per Loxley. Discontinue reason filled, cosign route set. Nothing constructed from working memory.",
            deepVoiceText:
              "Discontinue Crestor twenty. Place Crestor forty. The audit-trail note populates from the plan — increasing to forty milligrams from twenty per Loxley. The discontinue reason is filled. The cosign route is set. Nothing constructed from working memory at hour eight.",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          },
          {
            ...
            quickVoiceText:
              "Ninety days, three refills, Marchetti cosign — pulled from the Rx Request rule, not from memory. If the rule had flunked, Kairos would route to the Support Staff Pool with structured handoff context. The system remembers.",
            deepVoiceText:
              "Ninety days. Three refills. Standard diagnosis. Marchetti cosign. All of it pulled from the Rx Request rule, not from memory. Same documentation language every time. No drift. No exception slipping through because someone was tired or rushed. And if the rule had flunked — if the patient hadn't been seen in the last month — Kairos would route this to the Support Staff Pool with structured handoff context the front desk can act on directly. Not your problem to remember. The system remembers.",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          },
          {
            ...
            quickVoiceText:
              "Brief reply — thanks for clarifying, the best person to answer is the hematology team Loxley referred you to. No speculation. Routes to who can — and offers to follow up if the referral hasn't been scheduled.",
            deepVoiceText:
              "The reply itself is brief. Thanks for clarifying. That's a great question, and the best person to answer it is the hematology team Dr. Loxley referred you to last week. Doesn't pretend. Doesn't speculate. Doesn't paper over. Routes to who can — and offers to follow up if the referral hasn't been scheduled. The nurse isn't left alone deciding whether to guess.",
        ...
        annotations: [
          {
            ...
            quickVoiceText:
              "In pure Epic, this contradiction either gets caught by an alert nurse who happened to read the prior note — or it doesn't, and the patient bleeds. Here, Kairos holds the draft and routes to Marchetti with the contradiction flagged. The note records the side-by-side.",
            deepVoiceText:
        ...
        annotations: [
          {
            ...
            quickVoiceText:
              "Stage three. Loxley signed two notes — primary plan plus an addendum about B-N-P and Holter. Kairos absorbs both into one unified callback. The patient gets one coherent answer instead of two phone calls that don't quite line up.",
            deepVoiceText:
  ...
  // FIXTURE 9 — Vanstone denial cascade (Pattern 13)
  {
    ...
    preArrivalNarrator: {
      ...
      quickVoiceText:
        "Ms. Vanstone, fifty-eight. Atypical chest pain workup. Eight days, two denials, four Epic surfaces. In pure Epic, this isn't a card — it's scattered across half a dozen places, lived in working memory across days.",
      deepVoiceText:
        "Ms. Vanstone, fifty-eight. Atypical chest pain workup. Eight days ago, Dr. Loxley ordered a nuclear S-P-E-C-T. The card you're looking at represents the entire investigation since — and in pure Epic, this investigation isn't a card at all. It's scattered across half a dozen surfaces.",
