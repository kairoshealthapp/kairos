    ...
    actions: [
      {
        ...
        annotations: [
          {
            // Pass F — universal Step 3 (REVIEW OUTPUTS). Card 2 was
            // missing the Nurse Note review beat; the fixture generates
            // both nurse-note and mychart but only mychart had a
            // spotlight. New audioKey 'henderson-lipid-pa-note'.
            trigger: "after-action",
            anchor: "nurse-note",
            position: "right",
            style: "spotlight",
            audioKey: "henderson-lipid-pa-note",
            title: "Nurse Note drafted.",
            displayText: "Nurse Note drafted.",
            quickVoiceText:
              "The Nurse Note drafts in your clinical register — labs reviewed, plan documented, follow-up timing stated. Same voice you've always written in.",
            deepVoiceText:
              "The Nurse Note drafts in your clinical register — labs reviewed, plan documented, follow-up timing stated. Same voice you've always written in. The chart-resident artifact for this card.",
            body: "Nurse Note drafted.",
            durationMs: 5000,
          },
          {
            trigger: "after-action",
          ...
          {
            // Pass E #2 — disposition beat. Camera scrolls to the
            // action bar so the viewer sees the buttons before
            // Authorize fires. New audioKey 'henderson-lipid-disposition'.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            audioKey: "henderson-lipid-disposition",
            title: "Send. Sign. Done.",
            displayText: "Send. Sign. Done.",
            quickVoiceText:
              "Send the MyChart. Sign the note. No orders this card. One click.",
            deepVoiceText:
              "Send the MyChart. Sign the note. No orders to pend on this card. One click — both at once.",
            body: "Send. Sign. Done.",
            durationMs: 4000,
          },
        ],
