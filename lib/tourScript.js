...
const TOUR_SCRIPT = [
  ...
  // Fixture: halbrook-lab-review. Panels: RN Note + MyChart + Order Pad.
  {
    fixtureId: "halbrook-lab-review",
    progressLabel: "Card 2 of 7 — Ms. Howard",
    skipAutoAuthorize: true,
    preArrivalNarrator: {
      title: "Card 2 of 7 — Ms. Howard",
      audioKey: "mp2-howard-pre",
      targetCard: "halbrook-lab-review",
      cursor: {
        target: '[data-encounter-id="halbrook-lab-review"]',
        startTime: 500,
        arriveTime: 2200,
      },
  ...
  // ─────────────────────────────────────────────────────────────────────
  // CARD 7 — Sarah Halbrook DME (SECURE CHAT)
  // Fixture: halbrook-dme-pa. Panels: RN Note (with secure chat reply).
  {
    fixtureId: "halbrook-dme-pa",
    progressLabel: "Card 7 of 7 — Halbrook DME",
    skipAutoAuthorize: true,
    preArrivalNarrator: {
      title: "Card 7 of 7 — Halbrook DME",
      audioKey: "mp2-halbrook-pre",
      targetCard: "halbrook-dme-pa",
      cursor: {
        target: '[data-encounter-id="halbrook-dme-pa"]',
        startTime: 500,
        arriveTime: 2200,
      },
