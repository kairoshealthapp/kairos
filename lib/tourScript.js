...
const TOUR_SCRIPT = [
  ...
  // FIXTURE 2 — Wood lipid (Pattern 1)
  {
    ...
    preArrivalNarrator: {
      ...
      quickVoiceText:
        "Same box, simpler pattern. Mrs. Wood, sixty-eight. Lipid panel review — no med change, just patient education. Pure synthesis — provider decided, you document, you educate.",
      deepVoiceText:
        "Mrs. Wood, sixty-eight. Lipid panel review. L-D-L at goal, H-D-L slightly below, triglycerides slightly elevated. Dr. Beckweldon isn't changing meds — he wants the patient educated on lifestyle. This card type is most of your morning. Probably seventy percent of what hits your basket. Pure synthesis — provider decided, you document, you educate.",
    ...
    onArrival: {
      ...
      quickVoiceText:
        "L-D-L at goal, H-D-L slightly below, triglycerides slightly elevated. Beckweldon isn't changing meds — wants the patient educated on lifestyle. In pure Epic, this gets written from scratch every time, with phrasing that drifts shift to shift.",
      deepVoiceText:
  ...
  // FIXTURE 3 — Hesperdale Crestor (Pattern 4)
  {
    ...
    preArrivalNarrator: {
      ...
      deepVoiceText:
        "Ms. Hesperdale, fifty-nine. Lipid panel and chem-eight reviewed. L-D-L one-forty-two, above goal. Dr. Beckweldon wants Crestor uptitrated — twenty milligrams to forty — and a lipid panel plus hepatic function panel rechecked together in ninety days. In pure Epic, this card is roughly fourteen discrete actions. Watch.",
        ...
        annotations: [
          {
            ...
            quickVoiceText:
              "Discontinue Crestor twenty, place Crestor forty. Audit-trail note populates from the plan — increasing to forty per Beckweldon. Discontinue reason filled, cosign route set. Nothing constructed from working memory.",
            deepVoiceText:
              "Discontinue Crestor twenty. Place Crestor forty. The audit-trail note populates from the plan — increasing to forty milligrams from twenty per Beckweldon. The discontinue reason is filled. The cosign route is set. Nothing constructed from working memory at hour eight.",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          },
          {
            ...
            quickVoiceText:
              "Ninety days, three refills, Skarsdale cosign — pulled from the Rx Request rule, not from memory. If the rule had flunked, Kairos would route to the Support Staff Pool with structured handoff context. The system remembers.",
            deepVoiceText:
              "Ninety days. Three refills. Standard diagnosis. Skarsdale cosign. All of it pulled from the Rx Request rule, not from memory. Same documentation language every time. No drift. No exception slipping through because someone was tired or rushed. And if the rule had flunked — if the patient hadn't been seen in the last month — Kairos would route this to the Support Staff Pool with structured handoff context the front desk can act on directly. Not your problem to remember. The system remembers.",
  ...
  // FIXTURE 5 — Quennell scope-constrained (Pattern 12)
  {
    ...
    preArrivalNarrator: {
      ...
      quickVoiceText:
        "Ms. Quennell had elevated H-and-H last week, flagged for hematology referral. Yesterday she asked — could this cause low blood pressure? Vague. Kairos asked what this meant. She clarified — H-and-H. Now Kairos has to answer.",
      deepVoiceText:
        "Ms. Quennell, sixty-four. Last week, her labs showed elevated H-and-H — hemoglobin and hematocrit, mildly elevated, a finding Dr. Beckweldon flagged for hematology referral. Yesterday she replied to the lab message asking — quote — could this cause low blood pressure? Vague reference. Could mean any number of things. Kairos asked her what this meant. She clarified — she meant the H-and-H. Now Kairos has to answer.",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          },
          {
            ...
            quickVoiceText:
              "Brief reply — thanks for clarifying, the best person to answer is the hematology team Beckweldon referred you to. No speculation. Routes to who can — and offers to follow up if the referral hasn't been scheduled.",
            deepVoiceText:
              "The reply itself is brief. Thanks for clarifying. That's a great question, and the best person to answer it is the hematology team Dr. Beckweldon referred you to last week. Doesn't pretend. Doesn't speculate. Doesn't paper over. Routes to who can — and offers to follow up if the referral hasn't been scheduled. The nurse isn't left alone deciding whether to guess.",
  ...
  // FIXTURE 6 — Maundrell contradiction (Pattern 8)
  {
    ...
    preArrivalNarrator: {
      ...
      quickVoiceText:
        "Mr. Maundrell, seventy-four. I-N-R overdue MyChart went out four days ago. Today he replied — Dr. M told me to stop warfarin and the blood test. Chart still shows it active. No provider note documenting any discontinuation. Two facts that can't both be true.",
      deepVoiceText:
  ...
  // FIXTURE 7 — Underwell full lifecycle (Pattern 7b)
  {
    ...
    preArrivalNarrator: {
      ...
      quickVoiceText:
        "Mrs. Underwell, seventy-two. Hypertension, atrial fibrillation, C-A-D, mitral regurgitation, C-K-D, peripheral edema. She called this morning — blood pressure feels high, fuzzy thinking, swollen feet. One card, three stages. Highest-license work on the basket.",
      deepVoiceText:
        ...
        annotations: [
          {
            ...
            quickVoiceText:
              "Stage three. Beckweldon signed two notes — primary plan plus an addendum about B-N-P and Holter. Kairos absorbs both into one unified callback. The patient gets one coherent answer instead of two phone calls that don't quite line up.",
            deepVoiceText:
  ...
  // FIXTURE 9 — Larvendel denial cascade (Pattern 13)
  {
    ...
    preArrivalNarrator: {
      ...
      quickVoiceText:
        "Ms. Larvendel, fifty-eight. Atypical chest pain workup. Eight days, two denials, four Epic surfaces. In pure Epic, this isn't a card — it's scattered across half a dozen places, lived in working memory across days.",
      deepVoiceText:
        "Ms. Larvendel, fifty-eight. Atypical chest pain workup. Eight days ago, Dr. Beckweldon ordered a nuclear S-P-E-C-T. The card you're looking at represents the entire investigation since — and in pure Epic, this investigation isn't a card at all. It's scattered across half a dozen surfaces.",
