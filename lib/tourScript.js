...
const TOUR_SCRIPT = [
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 1 — Tunturi TTE (Pattern 2)
  {
    fixtureId: "aldington-tte",
    progressLabel: "Card 1 of 9 — Mr. Tunturi",
    preArrivalNarrator: {
      title: "Card 1 of 9 — Mr. Tunturi",
      audioKey: "tunturi-tte-pre",
    ...
    onAuthorize: {
      ...
      deepVoiceText:
        "One click. Note signed. MyChart sent. Order pended for Voronova's cosign. Today, this same workflow is roughly fourteen clicks across five Epic screens — and it happens differently for every nurse, every shift, every patient. The bigger story isn't the click count. It's that every T-T-E order Kairos pre-stages has the same thirteen fields filled the same correct way. The floor rises. Senior-nurse depth becomes the floor.",
      body: "One click.",
      durationMs: 5000,
    },
    transitionNarrator: {
      audioKey: "tunturi-tte-trans",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 2 — Hartvigsen lipid (Pattern 1)
  {
    fixtureId: "wood-lipid",
    progressLabel: "Card 2 of 9 — Mrs. Hartvigsen",
    preArrivalNarrator: {
      title: "Card 2 of 9 — Mrs. Hartvigsen",
      audioKey: "hartvigsen-lipid-pre",
      ...
      quickVoiceText:
        "Same box, simpler pattern. Mrs. Hartvigsen, sixty-eight. Lipid panel review — no med change, just patient education. Pure synthesis — provider decided, you document, you educate.",
      deepVoiceText:
        "Mrs. Hartvigsen, sixty-eight. Lipid panel review. L-D-L at goal, H-D-L slightly below, triglycerides slightly elevated. Dr. Voronova isn't changing meds — he wants the patient educated on lifestyle. This card type is most of your morning. Probably seventy percent of what hits your basket. Pure synthesis — provider decided, you document, you educate.",
    ...
    onArrival: {
      ...
      position: "right",
      style: "spotlight",
      audioKey: "hartvigsen-lipid-arrival",
      title: "Lipid panel review.",
      displayText: "Lipid panel review.",
      quickVoiceText:
        "L-D-L at goal, H-D-L slightly below, triglycerides slightly elevated. Voronova isn't changing meds — wants the patient educated on lifestyle. In pure Epic, this gets written from scratch every time, with phrasing that drifts shift to shift.",
      deepVoiceText:
    ...
    onAuthorize: {
      anchor: "global",
      style: "narrator-corner",
      audioKey: "hartvigsen-lipid-auth",
    ...
    transitionNarrator: {
      audioKey: "hartvigsen-lipid-trans",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 3 — Petrosyan Crestor (Pattern 4)
  {
    fixtureId: "calderwood-crestor",
    progressLabel: "Card 3 of 9 — Ms. Petrosyan",
    preArrivalNarrator: {
      title: "Card 3 of 9 — Ms. Petrosyan",
      audioKey: "petrosyan-crestor-pre",
      targetCard: "calderwood-crestor",
      cursor: {
        target: '[data-encounter-id="calderwood-crestor"]',
        startTime: 500,
        arriveTime: 2200,
        clickTime: null,
      },
      ...
      deepVoiceText:
        "Ms. Petrosyan, fifty-nine. Lipid panel and chem-eight reviewed. L-D-L one-forty-two, above goal. Dr. Voronova wants Crestor uptitrated — twenty milligrams to forty — and a lipid panel plus hepatic function panel rechecked together in ninety days. In pure Epic, this card is roughly fourteen discrete actions. Watch.",
    ...
    onArrival: {
      ...
      position: "right",
      style: "spotlight",
      audioKey: "petrosyan-crestor-arrival",
        ...
        annotations: [
          {
            ...
            position: "left",
            style: "spotlight",
            audioKey: "petrosyan-crestor-pa1",
            title: "Dose-change diff.",
            displayText: "Dose-change diff.",
            quickVoiceText:
              "Discontinue Crestor twenty, place Crestor forty. Audit-trail note populates from the plan — increasing to forty per Voronova. Discontinue reason filled, cosign route set. Nothing constructed from working memory.",
            deepVoiceText:
              "Discontinue Crestor twenty. Place Crestor forty. The audit-trail note populates from the plan — increasing to forty milligrams from twenty per Voronova. The discontinue reason is filled. The cosign route is set. Nothing constructed from working memory at hour eight.",
          ...
          },
          {
            ...
            position: "left",
            style: "spotlight",
            audioKey: "petrosyan-crestor-pa2",
            title: "Lab cluster.",
    ...
    onAuthorize: {
      anchor: "global",
      style: "narrator-corner",
      audioKey: "petrosyan-crestor-auth",
    ...
    transitionNarrator: {
      audioKey: "petrosyan-crestor-trans",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 4 — Fitzgerald-Ramos transactional (Pattern 9)
  {
    fixtureId: "norreys-transactional",
    progressLabel: "Card 4 of 9 — Mr. Fitzgerald-Ramos",
    preArrivalNarrator: {
      title: "Card 4 of 9 — Mr. Fitzgerald-Ramos",
      audioKey: "fitzgeraldramos-transactional-pre",
      ...
      quickVoiceText:
        "Rx Request box. Mr. Fitzgerald-Ramos had a supratherapeutic I-N-R nine days ago — Halloran dropped his warfarin from six-point-five to six milligrams. Today he wants the refill. Most cards in this box look exactly like this — same rule, fifty times a shift.",
      deepVoiceText:
        "Mr. Fitzgerald-Ramos, sixty-five. Coumadin Clinic patient. Nine days ago, his I-N-R ran three-point-nine — supratherapeutic — and Halloran dropped his warfarin from six-point-five milligrams to six. Today he replied to the dose-change message asking for a refill. The Rx Request box is full of these. Most cards in that box look exactly like this one — same rule, same shape, fifty times a shift.",
    ...
    onArrival: {
      ...
      position: "right",
      style: "spotlight",
      audioKey: "fitzgeraldramos-transactional-arrival",
      title: "Three preconditions, all met.",
      displayText: "Three preconditions, all met.",
      quickVoiceText:
        "In pure Epic, every nurse runs the same algorithm in her head — last visit, future appointment, refill ninety days or thirty. The rule lives in working memory, which means at hour eight, with twenty refills behind you, it drifts.",
      deepVoiceText:
        "Here's the algorithm every nurse runs in her head when a refill request lands. Has this patient been seen by cardiology in the last month? Click into the chart. Find the last cardiology encounter — yes, three weeks ago. Future appointment? Click into the schedule. Yes, in six weeks. Refill ninety days, three refills, document the rule, sign. Or — no future appointment. Refill thirty days only, document the kickout, route the message to the Cardiology Support Staff Pool with a note saying needs appointment scheduled before next refill. Same rule every time. But it lives in your head. Which means at hour eight, with twenty refills behind you and ten ahead, the rule drifts. Sometimes the kickout note routes to the wrong pool. Sometimes the patient never gets the follow-up appointment because the kickout got lost in the front desk inbox.",
        ...
        annotations: [
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "fitzgeraldramos-transactional-pa1",
          ...
          },
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "fitzgeraldramos-transactional-pa2",
          ...
          },
          {
            ...
            position: "left",
            style: "spotlight",
            audioKey: "fitzgeraldramos-transactional-pa3",
            title: "Rule-driven refill.",
            displayText: "Rule-driven refill.",
            quickVoiceText:
              "Ninety days, three refills, Halloran cosign — pulled from the Rx Request rule, not from memory. If the rule had flunked, Kairos would route to the Support Staff Pool with structured handoff context. The system remembers.",
            deepVoiceText:
              "Ninety days. Three refills. Standard diagnosis. Halloran cosign. All of it pulled from the Rx Request rule, not from memory. Same documentation language every time. No drift. No exception slipping through because someone was tired or rushed. And if the rule had flunked — if the patient hadn't been seen in the last month — Kairos would route this to the Support Staff Pool with structured handoff context the front desk can act on directly. Not your problem to remember. The system remembers.",
    ...
    onAuthorize: {
      anchor: "global",
      style: "narrator-corner",
      audioKey: "fitzgeraldramos-transactional-auth",
    ...
    transitionNarrator: {
      audioKey: "fitzgeraldramos-transactional-trans",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 5 — Skarsgård scope-constrained (Pattern 12)
  {
    fixtureId: "quennell-scope",
    progressLabel: "Card 5 of 9 — Ms. Skarsgård",
    preArrivalNarrator: {
      title: "Card 5 of 9 — Ms. Skarsgård",
      audioKey: "skarsgard-scope-pre",
      ...
      quickVoiceText:
        "Ms. Skarsgård had elevated H-and-H last week, flagged for hematology referral. Yesterday she asked — could this cause low blood pressure? Vague. Kairos asked what this meant. She clarified — H-and-H. Now Kairos has to answer.",
      deepVoiceText:
        "Ms. Skarsgård, sixty-four. Last week, her labs showed elevated H-and-H — hemoglobin and hematocrit, mildly elevated, a finding Dr. Voronova flagged for hematology referral. Yesterday she replied to the lab message asking — quote — could this cause low blood pressure? Vague reference. Could mean any number of things. Kairos asked her what this meant. She clarified — she meant the H-and-H. Now Kairos has to answer.",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          },
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "skarsgard-scope-pa2",
            title: "Redirected, not answered.",
            displayText: "Redirected, not answered.",
            quickVoiceText:
              "Brief reply — thanks for clarifying, the best person to answer is the hematology team Voronova referred you to. No speculation. Routes to who can — and offers to follow up if the referral hasn't been scheduled.",
            deepVoiceText:
              "The reply itself is brief. Thanks for clarifying. That's a great question, and the best person to answer it is the hematology team Dr. Voronova referred you to last week. Doesn't pretend. Doesn't speculate. Doesn't paper over. Routes to who can — and offers to follow up if the referral hasn't been scheduled. The nurse isn't left alone deciding whether to guess.",
    ...
    transitionNarrator: {
      audioKey: "skarsgard-scope-trans",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 6 — Solberg contradiction (Pattern 8)
  {
    fixtureId: "maundrell-contradiction",
    progressLabel: "Card 6 of 9 — Mr. Solberg",
    preArrivalNarrator: {
      title: "Card 6 of 9 — Mr. Solberg",
      audioKey: "solberg-contradiction-pre",
      ...
      quickVoiceText:
        "Mr. Solberg, seventy-four. I-N-R overdue MyChart went out four days ago. Today he replied — Dr. H told me to stop warfarin and the blood test. Chart still shows it active. No provider note documenting any discontinuation. Two facts that can't both be true.",
      deepVoiceText:
        "Mr. Solberg, seventy-four. Coumadin Clinic patient. Five days ago his I-N-R was therapeutic on six milligrams of warfarin — the dose he's been on for months. The I-N-R overdue MyChart template went out four days ago because he'd missed his routine check. Today he replied. Quote — Dr. H told me to be taking only the other two medications and also said I don't have to take the blood test anymore. Chart still shows warfarin active. No provider note documenting any discontinuation. Two facts that can't both be true.",
    ...
    onArrival: {
      ...
      position: "right",
      style: "spotlight",
      audioKey: "solberg-contradiction-arrival",
      title: "Two facts that can't both be right.",
      displayText: "Two facts. Both can't be right.",
      quickVoiceText:
        "In pure Epic, an I-N-R is a single discrete result — the dose history, the supratherapeutic spikes, the holds, all in different tabs. The nurse reconstructs the trajectory mentally on every call. Kairos brings the paper-flowsheet discipline back.",
      deepVoiceText:
        ...
        annotations: [
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "solberg-contradiction-pa1",
            title: "Contradiction documented.",
            displayText: "Contradiction documented.",
            quickVoiceText:
              "In pure Epic, this contradiction either gets caught by an alert nurse who happened to read the prior note — or it doesn't, and the patient bleeds. Here, Kairos holds the draft and routes to Halloran with the contradiction flagged. The note records the side-by-side.",
            deepVoiceText:
              "Today's plan from the provider would be — keep the dose. But the patient said something today that doesn't match the chart. These don't reconcile. In pure Epic, this contradiction either gets caught by an alert nurse who happens to have read the prior note, or it doesn't get caught at all and the dose continues, the I-N-R drifts, the patient bleeds. Here, instead of drafting an autonomous note that papers over the contradiction, Kairos holds the draft and routes to provider review with the contradiction flagged. The note records what the patient said, what the chart shows, the side-by-side. Forwarded to Halloran for verification.",
          ...
          },
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "solberg-contradiction-pa2",
    ...
    onAuthorize: {
      anchor: "global",
      style: "narrator-corner",
      audioKey: "solberg-contradiction-auth",
      title: "Same INR. Different plan.",
      displayText: "Same INR. Different plan.",
      quickVoiceText:
        "Same I-N-R result. Different plan. Kairos noticed. The contradiction is the output — not the reply. Today, in pure Epic, this would have gone out as a routine therapeutic-stable note.",
      deepVoiceText:
        "Same I-N-R result. Different plan. Kairos noticed. The contradiction is the output — not the reply. Today, in pure Epic, this would have gone out as a routine therapeutic-stable note. Here, the catch is the artifact.",
      body: "Same INR. Different plan.",
      durationMs: 5500,
    },
    transitionNarrator: {
      audioKey: "solberg-contradiction-trans",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 7 — Klausen full lifecycle (Pattern 7b)
  {
    fixtureId: "underwell-full-lifecycle",
    progressLabel: "Card 7 of 9 — Mrs. Klausen",
    preArrivalNarrator: {
      title: "Card 7 of 9 — Mrs. Klausen",
      audioKey: "klausen-full-lifecycle-pre",
      ...
      quickVoiceText:
        "Mrs. Klausen, seventy-two. Hypertension, atrial fibrillation, C-A-D, mitral regurgitation, C-K-D, peripheral edema. She called this morning — blood pressure feels high, fuzzy thinking, swollen feet. One card, three stages. Highest-license work on the basket.",
      deepVoiceText:
        "Mrs. Klausen, seventy-two. Active hypertension, atrial fibrillation, coronary artery disease, mitral regurgitation, chronic kidney disease, peripheral edema. She called the clinic this morning. Said her blood pressure feels high. Fuzzy thinking. Swollen feet. She wants to talk to a nurse. This is one card with three stages — and this is the highest-license work on the basket.",
    ...
    onArrival: {
      ...
      position: "top",
      style: "spotlight",
      audioKey: "klausen-full-lifecycle-arrival",
      title: "Three stages.",
        ...
        annotations: [
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "klausen-full-lifecycle-pa1",
        ...
        annotations: [
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "klausen-full-lifecycle-pa2",
            title: "Stage 2 — SBAR.",
        ...
        annotations: [
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "klausen-full-lifecycle-pa3",
            title: "Stage 3 — cross-note synthesis.",
            displayText: "Stage three — cross-note synthesis.",
            quickVoiceText:
              "Stage three. Voronova signed two notes — primary plan plus an addendum about B-N-P and Holter. Kairos absorbs both into one unified callback. The patient gets one coherent answer instead of two phone calls that don't quite line up.",
            deepVoiceText:
    ...
    onAuthorize: {
      anchor: "global",
      style: "narrator-corner",
      audioKey: "klausen-full-lifecycle-auth",
    ...
    transitionNarrator: {
      audioKey: "klausen-full-lifecycle-trans",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 8 — Tikhonova phone (Pattern 14)
  {
    fixtureId: "wexbury-phone",
    progressLabel: "Card 8 of 9 — Mrs. Tikhonova",
    preArrivalNarrator: {
      title: "Card 8 of 9 — Mrs. Tikhonova",
      audioKey: "tikhonova-phone-pre",
    ...
    onArrival: {
      ...
      position: "bottom",
      style: "spotlight",
      audioKey: "tikhonova-phone-arrival",
    ...
    transitionNarrator: {
      audioKey: "tikhonova-phone-trans",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 9 — Adesanya denial cascade (Pattern 13)
  {
    fixtureId: "vanstone-denial-cascade",
    progressLabel: "Card 9 of 9 — Ms. Adesanya",
    preArrivalNarrator: {
      title: "Card 9 of 9 — Ms. Adesanya",
      audioKey: "adesanya-denial-cascade-pre",
      targetCard: "vanstone-denial-cascade",
      cursor: {
        target: '[data-encounter-id="vanstone-denial-cascade"]',
        startTime: 500,
        arriveTime: 2200,
        clickTime: null,
      },
      ...
      quickVoiceText:
        "Ms. Adesanya, fifty-eight. Atypical chest pain workup. Eight days, two denials, four Epic surfaces. In pure Epic, this isn't a card — it's scattered across half a dozen places, lived in working memory across days.",
      deepVoiceText:
        "Ms. Adesanya, fifty-eight. Atypical chest pain workup. Eight days ago, Dr. Voronova ordered a nuclear S-P-E-C-T. The card you're looking at represents the entire investigation since — and in pure Epic, this investigation isn't a card at all. It's scattered across half a dozen surfaces.",
    ...
    onArrival: {
      ...
      position: "right",
      style: "spotlight",
      audioKey: "adesanya-denial-cascade-arrival",
        ...
        annotations: [
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "adesanya-denial-cascade-pa1",
          ...
          },
          {
            ...
            position: "left",
            style: "spotlight",
            audioKey: "adesanya-denial-cascade-pa2",
          ...
          },
          {
            ...
            position: "left",
            style: "spotlight",
            audioKey: "adesanya-denial-cascade-pa3",
    ...
    onAuthorize: {
      anchor: "global",
      style: "narrator-corner",
      audioKey: "adesanya-denial-cascade-auth",
      title: "One card.",
...
// Per a 2026-04-30 sample (Tunturi pre-arrival ≈ 343 chars at ≈ 22s of
