...
const TOUR_SCRIPT = [
  ...
  // FIXTURE 3 — Calderwood Crestor (Pattern 4)
  {
    ...
    progressLabel: "Card 3 of 7 — Ms. Calderwood",
    preArrivalNarrator: {
      title: "Card 3 of 7 — Ms. Calderwood",
      body:
  ...
  // FIXTURE 4 — Brexley statin (Pattern 5) — phiGuard demo
  {
    ...
    preArrivalNarrator: {
      ...
      body:
        "This is the safety moment. Statin choice — Dr. Loxley offered the patient a switch from Zetia to Nexlizet. Watch the first draft carefully.",
      durationMs: 5500,
    },
    onArrival: {
      anchor: "source-pane",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 7 — Vanstone denial cascade (Pattern 13)
  {
    fixtureId: "vanstone-denial-cascade",
    progressLabel: "Card 7 of 7 — Ms. Vanstone",
    preArrivalNarrator: {
      title: "Card 7 of 7 — Ms. Vanstone",
      body:
