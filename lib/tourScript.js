...
const TOUR_SCRIPT = [
  ...
  // FIXTURE 9 — Whitfield INR (Pattern 1, Coumadin Clinic)
  {
    ...
    preArrivalNarrator: {
      ...
      quickVoiceText:
        "Mrs. Whitfield, seventy-four. Atrial fibrillation, chronic warfarin. Coumadin Clinic — RN-protocol-driven, no provider involved for routine dosing. An I-N-R just landed.",
      deepVoiceText:
        "Mrs. Whitfield, seventy-four. Atrial fibrillation, chronic anticoagulation on warfarin. Coumadin Clinic — the workflow is RN-protocol-driven, the provider isn't in the loop for routine therapeutic dosing. An I-N-R result just landed in the inbox. The boring case the floor processes by the dozen.",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          },
          {
            ...
            quickVoiceText:
              "Sign the anticoagulation note. Send the MyChart. No provider in the loop — Coumadin Clinic is nurse-protocol-driven. One click.",
            deepVoiceText:
              "Sign the anticoagulation note. Send the MyChart. No provider needed — Coumadin Clinic is nurse-protocol-driven, that's the whole point of the protocol. One click — both at once.",
            body: "Sign. Send. Done.",
            durationMs: 5000,
          },
        ],
