    ...
    actions: [
        ...
        annotations: [
          {
            ...
            title: "Stage 2 — answers captured.",
            displayText: "Stage two — answers captured.",
            quickVoiceText:
              "Stage two. The patient answered. S-B-A-R will generate from these answers — same structure every time. Three clinical sharps already visible: B-P at goal but patient perceives high; persistent edema means dose reduction failed; new bilateral hand paresthesias flagged as new.",
            deepVoiceText:
              "Stage two. The patient answered the questions. The S-B-A-R will generate from these answers — same structure every time, the structure providers read fastest. Three clinical sharps already visible in the responses: blood pressures at goal but the patient perceives them as high; persistent edema means the dose reduction failed; new bilateral hand paresthesias flagged as new. The format won't drift between nurses, between shifts, between this call and the last one.",
            body: "Stage two — answers captured.",
            durationMs: 6500,
          },
        ],
      },
      {
        ...
        annotations: [
          ...
          {
            // Pass D Phase 2 — Issue 7F: 'look what we just did' final
            // wide-shot beat before Authorize fires. Camera pulls back
            // to patient-header so the assessment + responses + SBAR
            // are all visible together. New audioKey
            // 'reed-full-lifecycle-pa3b' to be generated in Phase 9.
            trigger: "after-action",
            anchor: "patient-header",
            position: "bottom",
            style: "spotlight",
            audioKey: "reed-full-lifecycle-pa3b",
            title: "All three artifacts — together.",
            displayText: "All three artifacts — together.",
            quickVoiceText:
              "Six questions. Real responses. One unified S-B-A-R routed to Pendrelle. Two hours of clinical work, condensed into one card.",
            deepVoiceText:
              "Six questions. Real responses. One unified S-B-A-R routed to the provider. The assessment, the captured answers, and the synthesized callback all live on this card — every artifact of two hours of clinical investigation, available at a glance to whichever nurse picks up the chart next.",
            body: "All three artifacts — together.",
            durationMs: 5500,
          },
        ],
      },
