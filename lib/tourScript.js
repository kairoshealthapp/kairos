...
const TOUR_SCRIPT = [
  ...
  // FIXTURE 1 — Anderson TTE (Pattern 2)
  {
    ...
    progressLabel: "Card 1 of 10 — Mr. Anderson",
    preArrivalNarrator: {
      title: "Card 1 of 10 — Mr. Anderson",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          {
            // Pass E #2 — disposition beat. Camera scrolls to the
            // bottom of the encounter so the viewer sees the action
            // buttons before Authorize fires. New audioKey
            // 'anderson-tte-disposition' generated in Pass E batch.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            audioKey: "anderson-tte-disposition",
            title: "Send. Sign. Done.",
            displayText: "Send. Sign. Done.",
            quickVoiceText:
              "Send the MyChart. Sign the note. Order pended for cosign. One click — all three.",
            deepVoiceText:
              "Send the MyChart. Sign the note. Order pended for Pendrelle's cosign. One click — all three at once.",
            body: "Send. Sign. Done.",
            durationMs: 4500,
          },
        ],
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 2 — Bennett Crestor (Pattern 4)
  {
    fixtureId: "hesperdale-crestor",
    progressLabel: "Card 2 of 10 — Ms. Bennett",
    preArrivalNarrator: {
      title: "Card 2 of 10 — Ms. Bennett",
    ...
    actions: [
      {
        ...
        annotations: [
          {
            // Pass F — Step 3 review beat for Nurse Note (was missing
            // on Card 3; only Order Pad was reviewed). New audioKey
            // 'bennett-crestor-pa-note'.
            trigger: "after-action",
            anchor: "nurse-note",
            position: "right",
            style: "spotlight",
            audioKey: "bennett-crestor-pa-note",
            title: "Nurse Note — dose change documented.",
            displayText: "Nurse Note — dose change documented.",
            quickVoiceText:
              "The Nurse Note documents the dose change, the trend, the rationale. Same voice you've always written in.",
            deepVoiceText:
              "The Nurse Note documents the dose change, the trend that prompted it, the rationale. Same voice you've always written in — drafted from your prior notes, not reconstructed from working memory at hour eight.",
            body: "Nurse Note — dose change documented.",
            durationMs: 5000,
          },
          {
            // Pass F — Step 3 review beat for MyChart (was missing on
            // Card 3). New audioKey 'bennett-crestor-pa-mychart'.
            trigger: "after-action",
            anchor: "output-pane",
            position: "left",
            style: "spotlight",
            audioKey: "bennett-crestor-pa-mychart",
            title: "MyChart — patient-facing rationale.",
            displayText: "MyChart — patient-facing rationale.",
            quickVoiceText:
              "MyChart drafts in patient-facing register — explains the dose increase, what to watch for, when the labs are due back.",
            deepVoiceText:
              "MyChart drafts in patient-facing register — explains the dose increase, what to watch for, the labs due back in ninety days, when to call. Specific to her trajectory, not generic.",
            body: "MyChart — patient-facing rationale.",
            durationMs: 5500,
          },
          {
            trigger: "after-action",
          ...
          {
            // Pass F Step 4 — disposition beat. New audioKey
            // 'bennett-crestor-disposition'.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            audioKey: "bennett-crestor-disposition",
            title: "Send. Sign. Done.",
            displayText: "Send. Sign. Done.",
            quickVoiceText:
              "Send the MyChart. Sign the note. Dose change and lab cluster pended for cosign. One click — all of it.",
            deepVoiceText:
              "Send the MyChart. Sign the note. The dose change and the lab cluster both pended for Pendrelle's cosign. One click — all of it at once.",
            body: "Send. Sign. Done.",
            durationMs: 4500,
          },
        ],
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 3 — Stewart transactional (Pattern 9)
  {
    fixtureId: "norreys-transactional",
    progressLabel: "Card 3 of 10 — Mr. Stewart",
    preArrivalNarrator: {
      title: "Card 3 of 10 — Mr. Stewart",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          {
            // Pass F Step 4 — disposition beat. New audioKey
            // 'stewart-transactional-disposition'.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            audioKey: "stewart-transactional-disposition",
            title: "Send. Sign. Done.",
            displayText: "Send. Sign. Done.",
            quickVoiceText:
              "Send the confirmation. Sign the note. Refill pended for Reynolds cosign. One click.",
            deepVoiceText:
              "Send the one-line confirmation. Sign the note. The ninety-day refill pended for Reynolds cosign. One click — all three.",
            body: "Send. Sign. Done.",
            durationMs: 4500,
          },
        ],
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 4 — Nguyen scope-constrained (Pattern 12)
  {
    fixtureId: "quennell-scope",
    progressLabel: "Card 4 of 10 — Ms. Nguyen",
    preArrivalNarrator: {
      title: "Card 4 of 10 — Ms. Nguyen",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          {
            // Pass F Step 4 — disposition beat. New audioKey
            // 'nguyen-scope-disposition'.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            audioKey: "nguyen-scope-disposition",
            title: "Send. Sign. Done.",
            displayText: "Send. Sign. Done.",
            quickVoiceText:
              "Send the redirect. Sign the note. Scope decision documented. One click.",
            deepVoiceText:
              "Send the redirect to the patient. Sign the note. The scope decision and the routing are documented. One click — done.",
            body: "Send. Sign. Done.",
            durationMs: 4500,
          },
        ],
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 5 — Foster contradiction (Pattern 8)
  {
    fixtureId: "maundrell-contradiction",
    progressLabel: "Card 5 of 10 — Mr. Foster",
    preArrivalNarrator: {
      title: "Card 5 of 10 — Mr. Foster",
    ...
    actions: [
      {
        ...
        annotations: [
          {
            // Pass F — Card 6 special case per master task: 'Step 1
            // must highlight BOTH the source AND the red CONTRADICTION
            // HOLD banner.' The onArrival beat already gold-boxes the
            // source; this annotation gold-boxes the contradiction
            // alert banner immediately after the action fires (the
            // alert is rendered from fixture mount, so the banner has
            // been visible since the encounter loaded). New audioKey
            // 'foster-contradiction-alert'.
            trigger: "after-action",
            anchor: "contradiction-alert",
            position: "bottom",
            style: "spotlight",
            audioKey: "foster-contradiction-alert",
            title: "Chart says one thing. Patient says another.",
            displayText: "Chart vs. patient.",
            quickVoiceText:
              "Chart says warfarin active. Patient says he stopped. Kairos held everything and flagged the mismatch — the alert at the top is the headline of this card.",
            deepVoiceText:
              "Chart says warfarin active. Patient says he stopped. No provider note documents a discontinuation. Kairos held all autonomous output and flagged the mismatch as a chart-contradiction alert. The red banner at the top of the encounter is the headline — before any drafting happens, the system says: this can't both be right.",
            body: "Chart vs. patient.",
            durationMs: 6000,
          },
          {
            trigger: "after-action",
          ...
          {
            // Pass F Step 4 — disposition beat. Forward to provider
            // is the disposition; nothing goes to the patient. New
            // audioKey 'foster-contradiction-disposition'.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            ...
            quickVoiceText:
              "Forward to Reynolds. No patient reply yet — wait for the on-or-off clarification. One click.",
            deepVoiceText:
              "Forward to Reynolds for the on-or-off clarification. No reply to the patient until the provider confirms — that's the safety hold. One click — done.",
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 6 — Reed full lifecycle (Pattern 7b)
  {
    fixtureId: "underwell-full-lifecycle",
    progressLabel: "Card 6 of 10 — Mrs. Reed",
    preArrivalNarrator: {
      title: "Card 6 of 10 — Mrs. Reed",
    ...
    onArrival: {
      // Pass F — universal Step 1 SOURCE anchor. Was 'action-bar'
      // (which jumped straight to the Generate button); now points
      // to the source-pane so the viewer reads what came in (the
      // patient call summary) before anything else fires. The cursor
      // still moves to the Stage 1 Generate button at the end of the
      // narration to launch the assessment generation.
      anchor: "source-pane",
      position: "right",
      style: "spotlight",
    ...
    actions: [
      {
        ...
        annotations: [
          {
            // Pass D Phase 2 — Issue 7D: anchor moved from 'nurse-note'
            // (which doesn't exist in TriageEncounter) to
            // 'patient-assessment' so the spotlight outlines the actual
            // questions pane that just rendered. Cursor stays on the
            // Stage 2 button per Pass C cue alignment.
            trigger: "after-action",
            ...
            quickVoiceText:
              "Stage one. Six questions across five categories, tuned to her chart — symptom characterization, red flags, functional status, med compliance against her real med list. Senior-nurse depth on every call.",
            deepVoiceText:
              "Stage one. Kairos pulls structured chart context automatically — meds, recent labs, last visit, B-P-s, weight history, A-1-c. Six questions generate across five categories. Symptom characterization. Associated symptoms and red flags. Functional status. Medication compliance against her actual med list — not a generic checklist, her med list. Plus chart-context callouts: a medication she stopped taking last month that's relevant to today's symptoms — flagged. Senior-nurse depth on every call, regardless of which nurse picked up.",
            body: "Stage one — chart-aware questions.",
            durationMs: 5500,
          },
          {
            // Pass D Phase 2 — Issue 7C: clarifying beat between
            // assessment generation and response capture. Without this
            // the next stage's responses appear with no explanation of
            // HOW they got there. Reuses orphaned audioKey
            // 'reed-full-lifecycle-pa1b' (will be generated in Phase 9
            // batch). Anchor on patient-assessment again, no cursor cue
            // (cursor is parked from the prior beat's click target).
            trigger: "after-action",
            anchor: "patient-assessment",
            position: "left",
            style: "spotlight",
            audioKey: "reed-full-lifecycle-pa1b",
            title: "Patient receives via MyChart.",
            displayText: "Patient receives via MyChart.",
            quickVoiceText:
              "The patient receives the assessment in MyChart. Their replies populate the response pane in real time as they answer.",
            deepVoiceText:
              "The patient receives the assessment in MyChart. Their replies populate the response pane in real time as they answer — same six questions, structured form, the same content the nurse would otherwise capture by phone if MyChart wasn't available. The mode flexes per patient. The clinical reasoning doesn't drift.",
            body: "Patient receives via MyChart.",
            durationMs: 4500,
          },
        ],
      },
      {
        ...
        annotations: [
          {
            // Pass D Phase 2 — Issue 7D: anchor moved to patient-response
            // (the responses pane is what just got populated when
            // process-reply / Send-via-MyChart fired). Stage 2 narration
            // is about the SBAR-from-answers synthesis preview; the
            // responses are the visible artifact at this moment.
            trigger: "after-action",
            anchor: "patient-response",
            position: "right",
            style: "spotlight",
            audioKey: "reed-full-lifecycle-pa2",
            // Pass E #3 — narration rewritten to be workflow-focused
            // per master task: "The patient's answers are in. Hit
            // Synthesize SBAR." Strip clinical specifics — those live
            // in the responses themselves. Cursor timings shortened
            // to match the new ~3-7s audio.
            //
            // Pass G-fix3 #4 — replaced extraHoldMs (6s AFTER audio,
            // which produced dead air between "Hit Synthesize SBAR" and
            // the click) with prePlayHoldMs (6s BEFORE audio, so
            // viewer reads the freshly-rendered Q1-Q6 + answers
            // silently, THEN narration plays and ends with the click).
            // Cursor timings are now relative to audio start (not
            // beat-start) so click lines up with audio end.
            //
            // Pass G-fix2 — cinematicFraming: "top" so Q1 lands at the
            // top of the viewport and the viewer reads from Q1 down,
            // not mid-page starting at Q4-Q6.
            ...
            title: "Answers in.",
            displayText: "Answers in.",
            quickVoiceText:
              "The patient's answers are in. Hit Synthesize SBAR.",
            deepVoiceText:
              "The patient's answers are in. The structured form captured what a senior nurse would have asked by phone — but here, in writing, on every call. Hit Synthesize SBAR.",
            body: "Answers in.",
            durationMs: 4500,
          },
        ],
      },
      {
        ...
        annotations: [
          {
            // Pass D Phase 2 — Issue 7D: anchor moved to 'sbar' (the
            // SBAR pane just rendered when stage advanced to 4).
            trigger: "after-action",
            anchor: "sbar",
            position: "top",
            style: "spotlight",
            audioKey: "reed-full-lifecycle-pa3",
            // Pass E #3 — narration rewritten to focus on workflow,
            // not clinical specifics. No 'Pendrelle', no 'BNP', no 'Holter'
            // — those references confuse the workflow story. Don't
            // say 'Authorize' — say 'forward to provider' (button
            // label vs. clinical action). Cursor timings shortened to
            // match the new audio.
            //
            // Pass G-fix3 #4 — replaced extraHoldMs (6s AFTER audio)
            // with prePlayHoldMs (6s BEFORE audio). Viewer reads SBAR
            // silently for 6s, then narration "S-B-A-R is ready,
            // forward it" plays, then click — no dead air after
            // "forward it" before the camera moves.
            // Pass G-fix #4c — cinematicFraming: "top" pins the SBAR
            // header to the top of the viewport instead of centering
            // mid-pane, so the viewer reads the SBAR from S→B→A→R.
            cinematicFraming: "top",
            prePlayHoldMs: 6000,
            cursor: {
            ...
            title: "SBAR ready.",
            displayText: "SBAR ready.",
            quickVoiceText:
              "The S-B-A-R is ready. Forward it to the provider for clinical direction.",
            deepVoiceText:
              "The S-B-A-R is ready. Same structure every time, the structure providers read fastest. Forward it to the provider for clinical direction.",
            body: "SBAR ready.",
            durationMs: 4500,
          },
          {
            // Pass E #3 — pa3b is now the "scroll to disposition" beat
            // per master task. Camera pulls down to the action bar so
            // the viewer sees the 'Authorize → forward to provider'
            // button before it fires. Pendrelle reference stripped per
            // master task.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            audioKey: "reed-full-lifecycle-pa3b",
            title: "Forward the SBAR.",
            displayText: "Forward the SBAR.",
            quickVoiceText:
              "Six questions. Real responses. One unified S-B-A-R, forwarded to the provider for clinical direction.",
            deepVoiceText:
              "Six questions. Real responses. One unified S-B-A-R. The assessment, the captured answers, and the synthesized callback all live on this card — forwarded to the provider for clinical direction.",
            body: "Forward the SBAR.",
            durationMs: 5000,
          },
        ],
      },
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 7 — Greene phone (Pattern 14)
  {
    fixtureId: "wexbury-phone",
    progressLabel: "Card 7 of 10 — Mrs. Greene",
    preArrivalNarrator: {
      title: "Card 7 of 10 — Mrs. Greene",
    ...
    onArrival: {
      // Pass F — universal Step 1 SOURCE anchor. Was 'patient-header'
      // (which gold-boxed the MyChart Pending status chip); now points
      // to source-pane so the viewer reads the TTE result first. The
      // narration still mentions the patient header / MyChart Pending
      // status because that's what triggers the channel-aware reply
      // pane choice — but the gold box sits on the source itself.
      anchor: "source-pane",
      position: "right",
      style: "spotlight",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          {
            // Pass E #2 — disposition beat for Card 8. Phone-channel
            // disposition: Sign the note (the only artifact that enters
            // the chart since the phone script is ephemeral). New
            // audioKey 'greene-phone-disposition'.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            audioKey: "greene-phone-disposition",
            title: "Sign. Done.",
            displayText: "Sign. Done.",
            quickVoiceText:
              "Sign the note. The phone script stays ephemeral. One click.",
            deepVoiceText:
              "Sign the note. The phone-script pane stays ephemeral — never enters the chart. Just the note signs. One click.",
            body: "Sign. Done.",
            durationMs: 4000,
          },
        ],
  ...
  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 8 — Jackson denial cascade (Pattern 13)
  {
    fixtureId: "larvendel-denial-cascade",
    progressLabel: "Card 8 of 10 — Ms. Jackson",
    preArrivalNarrator: {
      title: "Card 8 of 10 — Ms. Jackson",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          {
            // Pass G-fix #5 — RN Note review beat (was missing on
            // Card 9 per master task). Inserted between output-pane
            // (MyChart outreach) and action-bar (disposition) so the
            // sequence follows the universal SOURCE → GENERATE →
            // REVIEW → DISPOSITION choreography. New audioKey
            // 'jackson-denial-cascade-pa-note' — regen on next audio
            // build pass.
            trigger: "after-action",
            anchor: "nurse-note",
            position: "right",
            style: "spotlight",
            audioKey: "jackson-denial-cascade-pa-note",
            title: "RN note — cascade in writing.",
            displayText: "RN note — cascade in writing.",
            quickVoiceText:
              "Kairos drafts the RN note alongside the outreach. Both denials, the alt-orders, the peer-to-peer deadline — all written down so the next nurse picks up the cascade instead of rebuilding it from scratch.",
            deepVoiceText:
              "Kairos drafts the RN note alongside the patient outreach. The note records the full cascade in writing — denial number one with the Evolent guideline, the alternate stress echo, the Lexiscan attempted and cancelled, the C-T-A Coronary, denial number two, the peer-to-peer deadline. The next nurse who picks up this card reads the cascade from the note instead of rebuilding it from working memory across four Epic surfaces.",
            body: "RN note — cascade in writing.",
            durationMs: 6000,
          },
          {
            // Pass F Step 4 — disposition beat. Card 9 has two
            // disposition paths per master task: schedule peer-to-
            // peer (today only) OR forward to provider for resubmit
            // / next-step decision. The action bar exposes both
            // buttons; the spotlight outlines them and the narration
            // names both paths. New audioKey
            // 'jackson-denial-cascade-disposition'.
            trigger: "after-action",
            anchor: "action-bar",
            position: "top",
            style: "spotlight",
            audioKey: "jackson-denial-cascade-disposition",
            title: "Two paths.",
            displayText: "Two paths.",
            quickVoiceText:
              "Two paths from here. Schedule the peer-to-peer today — deadline-bound. Or forward to the provider for the next-step decision. The card carries the cascade either way.",
            deepVoiceText:
              "Two paths from here. Path A: schedule the peer-to-peer today — deadline-bound, and the only window to overturn the denial without resubmitting. Path B: forward to the provider for the next-step decision — escalate to heart cath given the symptoms, or resubmit with new documentation. The card carries the full cascade either way; the next nurse who picks it up doesn't rebuild context.",
            body: "Two paths.",
            durationMs: 6500,
          },
        ],
    ...
    transitionNarrator: {
      audioKey: "jackson-denial-cascade-trans",
      title: "Different gear — the boring case.",
      displayText: "Different gear — the boring case.",
      quickVoiceText:
        "Different gear next. A routine I-N-R result on KOO-muh-din Clinic protocol. Same boring case the floor processes by the dozen — and the place where the living-document pattern earns its keep.",
      deepVoiceText:
        "Different gear next. A routine I-N-R result on KOO-muh-din Clinic protocol — RN nurse-protocol-driven, no provider in the loop for therapeutic dosing. The boring case. The same boring case the floor processes by the dozen every shift. And the place where Kairos's living-document pattern earns its keep — the trajectory carried forward note to note, instead of rebuilt from working memory each time.",
      body: "Different gear — the boring case.",
      durationMs: 4500,
    },
  },

  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 9 — Whitfield INR (Pattern 1, Coumadin Clinic)
  {
    fixtureId: "whitfield-inr",
    progressLabel: "Card 9 of 10 — Mrs. Whitfield",
    preArrivalNarrator: {
      title: "Card 9 of 10 — Mrs. Whitfield",
      audioKey: "whitfield-inr-pre",
      ...
      displayText: "Coumadin Clinic — RN protocol.",
      quickVoiceText:
        "Mrs. Whitfield, seventy-four. Atrial fibrillation, chronic warfarin. KOO-muh-din Clinic — RN-protocol-driven, no provider involved for routine dosing. An I-N-R just landed.",
      deepVoiceText:
        "Mrs. Whitfield, seventy-four. Atrial fibrillation, chronic anticoagulation on warfarin. KOO-muh-din Clinic — the workflow is RN-protocol-driven, the provider isn't in the loop for routine therapeutic dosing. An I-N-R result just landed in the inbox. The boring case the floor processes by the dozen.",
      body: "Coumadin Clinic — RN protocol.",
      durationMs: 5200,
    },
    onArrival: {
      anchor: "source-pane",
      position: "right",
      style: "spotlight",
      audioKey: "whitfield-inr-arrival",
      cursor: {
        target: "#kairos-action-generate-note-mychart",
        startTime: 8500,
        arriveTime: 9800,
      ...
      title: "An I-N-R just landed.",
      displayText: "An I-N-R just landed.",
      quickVoiceText:
        "An I-N-R result just landed. Two-point-three, therapeutic. That's the entire source — just the lab value. In pure Epic, the trend lives in another tab and the dose history lives in a third.",
      deepVoiceText:
        "An I-N-R result just landed in the RESULTS basket — two-point-three, therapeutic, range two-to-three. That's the entire source artifact. Just the lab value. In pure Epic, the trend over the last six months lives in a separate Results trending tab. The current warfarin dose lives in the meds tab. The last hospitalization that explains why she's on warfarin lives in a discharge summary three months back. Each I-N-R encounter is treated as a one-off, and the nurse mentally reconstructs the trajectory before drafting.",
      body: "An I-N-R just landed.",
      durationMs: 5500,
    },
    actions: [
      {
        ...
        annotations: [
          {
            ...
            position: "right",
            style: "spotlight",
            audioKey: "whitfield-inr-pa-note",
            title: "Anticoagulation note — the living document.",
            displayText: "Living document.",
            quickVoiceText:
              "Kairos pulled the prior KOO-muh-din note and updated it. The trend line carries forward — eight values, the recent trajectory visible. The clinical-context line about the November hospitalization carried forward too. The note is the living document.",
            deepVoiceText:
              "Kairos pulled the prior KOO-muh-din note and synthesized the new one with today's value layered in. Look at the trend line — eight values across six months, all visible at a glance. The clinical-context paragraph about the November hospitalization, the no-bleeding-events line, the takes-warfarin-at-six-P-M detail — carried forward from the prior note. This is the living-document pattern. Every KOO-muh-din note contains the full trajectory. The nurse used to copy the prior note, edit it, retype the trend line. Kairos automates the copy-forward-and-synthesize step the floor does manually every encounter.",
            body: "Living document.",
            durationMs: 6500,
          },
          {
            trigger: "after-action",
            ...
            position: "left",
            style: "spotlight",
            audioKey: "whitfield-inr-pa-mychart",
            title: "MyChart — patient notification.",
            displayText: "Patient notification.",
            quickVoiceText:
              "MyChart drafts the patient notification — value in target, no dose change, next draw in four weeks. Plain language.",
            deepVoiceText:
              "MyChart drafts the patient-facing notification — value in target, continue current dose, next draw in four weeks, when to call. Plain language. Same depth every time, regardless of nurse or shift.",
            body: "Patient notification.",
            durationMs: 4500,
          },
          {
            trigger: "after-action",
            ...
            position: "top",
            style: "spotlight",
            audioKey: "whitfield-inr-disposition",
            title: "Sign. Send. Done.",
            displayText: "Sign. Send. Done.",
            quickVoiceText:
              "Sign the anticoagulation note. Send the MyChart. No provider in the loop — KOO-muh-din Clinic is nurse-protocol-driven. One click.",
            deepVoiceText:
              "Sign the anticoagulation note. Send the MyChart. No provider needed — KOO-muh-din Clinic is nurse-protocol-driven, that's the whole point of the protocol. One click — both at once.",
            body: "Sign. Send. Done.",
            durationMs: 5000,
          },
        ],
    ...
    onAuthorize: {
      ...
      title: "The boring case, automated.",
      displayText: "The boring case, automated.",
      quickVoiceText:
        "Boring cases are most of the day. Living documents that copy forward, trend lines that update, patient notifications that always say what they need to say. Kairos automates the copy-forward-and-synthesize step the floor does manually every encounter.",
      deepVoiceText:
        "The boring cases are most of the day — and the place a tool like Kairos has to work, not just on the dramatic ones. Living documents that copy forward. Trend lines that update. Patient notifications that always include the right four sentences. Kairos automates the copy-forward-and-synthesize step the floor does manually every encounter, on every KOO-muh-din patient.",
      body: "The boring case, automated.",
      durationMs: 5500,
    },
    transitionNarrator: {
      audioKey: "whitfield-inr-trans",
      title: "Last one — the headline.",
      displayText: "Last one — the headline.",
      quickVoiceText:
        "Last card. The one where the demo lands. Clinical reasoning is thirty seconds. The plumbing — fifteen to twenty minutes by hand. Kairos collapses the plumbing.",
      deepVoiceText:
        "Last card. The one where the demo really lands. An E-P referral — clinical reasoning is thirty seconds, the plumbing is fifteen to twenty minutes across five Epic surfaces. Kairos collapses the plumbing into one Authorize click.",
      body: "Last one — the headline.",
      durationMs: 4500,
    },
  },

  // ─────────────────────────────────────────────────────────────────────
  // FIXTURE 10 — Beasley EP Referral (Pattern 6r — referral packet)
  {
    fixtureId: "beasley-ep-referral",
    progressLabel: "Card 10 of 10 — Mr. Beasley",
    preArrivalNarrator: {
      title: "Card 10 of 10 — Mr. Beasley",
      audioKey: "beasley-ep-referral-pre",
      targetCard: "beasley-ep-referral",
      cursor: {
        target: '[data-encounter-id="beasley-ep-referral"]',
        startTime: 500,
        arriveTime: 2200,
        clickTime: null,
      },
      displayText: "Holter result — refer EP.",
      quickVoiceText:
        "Mr. Beasley, sixty-four. CAD with prior stents. Holter showed sustained V-T. Pendrelle wants an E-P eval at Riverside Medical Center for I-C-D candidacy. The headline card.",
      deepVoiceText:
        "Mr. Beasley, sixty-four. C-A-D with two prior stents. Recent Holter monitor showed multiple sustained V-T runs, longest twelve seconds. Ejection fraction thirty-five percent on echo two months ago. Pendrelle NP reviewed the Holter and wants an electrophysiology evaluation at Riverside Medical Center — I-C-D candidacy. The clinical reasoning is thirty seconds. The paperwork is fifteen to twenty minutes. The headline card for the demo.",
      body: "Holter result — refer EP.",
      durationMs: 5500,
    },
    onArrival: {
      anchor: "source-pane",
      position: "right",
      style: "spotlight",
      audioKey: "beasley-ep-referral-arrival",
      cursor: {
        target: "#kairos-action-assemble-ep-referral",
        startTime: 9000,
        arriveTime: 10300,
        clickTime: 11500,
        deep: {
      ...
      title: "Holter — sustained VT. Refer EP.",
      displayText: "Refer EP.",
      quickVoiceText:
        "A Holter result just came back. Sustained V-T, longest twelve seconds. Pendrelle wants an E-P eval at Riverside Medical Center for I-C-D candidacy. Thirty seconds of clinical reasoning. Then the paperwork.",
      deepVoiceText:
        "A Holter result just came back. Multiple sustained V-T runs, longest twelve seconds, on top of an ejection fraction of thirty-five and a C-A-D history with prior stents. Pendrelle NP reviewed it and wrote: refer to E-P at Riverside Medical Center for I-C-D candidacy, communicate to patient. The clinical decision is thirty seconds. In pure Epic, what comes next is fifteen to twenty minutes of paperwork — the note, the MyChart, the referral order, the cover letter, the chart-review documents pulled from across five tabs, the insurance card and photo I-D from Media, the fax cover sheet, the fax number lookup. Kairos collapses all of that.",
      body: "Refer EP.",
      durationMs: 5500,
    },
    actions: [
      {
        actionId: "assemble-ep-referral",
        annotations: [
          {
            trigger: "after-action",
            anchor: "nurse-note",
            position: "right",
            style: "spotlight",
            audioKey: "beasley-ep-referral-pa-note",
            title: "Note — referral documented.",
            displayText: "Note drafted.",
            quickVoiceText:
              "The note documents Pendrelle's review, the V-T finding, the E-F, and the referral placed to Riverside E-P with the fax number. Audit trail in writing.",
            deepVoiceText:
              "The note documents Pendrelle's Holter review, the V-T finding, the E-F at thirty-five, the C-A-D history, and the referral placed to Riverside Medical Center E-P — Dr. Ashworth's office — with the fax number. Audit trail in writing. Same content the nurse used to draft from working memory at hour seven of the shift.",
            body: "Note drafted.",
            durationMs: 5500,
          },
          {
            ...
            position: "left",
            style: "spotlight",
            audioKey: "beasley-ep-referral-pa-mychart",
            title: "MyChart — patient-facing.",
            displayText: "MyChart drafted.",
            quickVoiceText:
              "MyChart explains the referral in patient language — irregular rhythm, specialist consult, records sent ahead, ER if symptomatic before the appointment.",
            deepVoiceText:
              "MyChart explains the referral in patient-facing register — irregular rhythm, specialist consult, the records have been sent ahead so they have everything they need, two-week timeline, E-R if symptomatic before the appointment. Plain language. Same depth every time.",
            body: "MyChart drafted.",
            durationMs: 5500,
          },
          {
            trigger: "after-action",
            ...
            position: "left",
            style: "spotlight",
            audioKey: "beasley-ep-referral-pa-orders",
            title: "Referral order — staged.",
            displayText: "Referral order staged.",
            quickVoiceText:
              "Ambulatory referral to E-P, routine, indication populated, Pendrelle cosign route, auth pending. Order placed before the packet assembles.",
            deepVoiceText:
              "Ambulatory referral order — Electrophysiology, Riverside Medical Center, routine priority, indication populated from the Holter finding, diagnosis associations carried, Pendrelle cosign route set, authorization pending. The order is placed before the packet assembles, so the packet has something to attach to.",
            body: "Referral order staged.",
            durationMs: 5500,
          },
          {
            trigger: "after-action",
            ...
            position: "top",
            // Pass G-fix2 — top framing so the packet header (destination
            // + cover letter chip) lands at the top of the viewport.
            cinematicFraming: "top",
            style: "spotlight",
            audioKey: "beasley-ep-referral-pa-packet",
            title: "The fifteen minutes — collapsed.",
            displayText: "Packet — pre-assembled.",
            // Pass E §3 — extended dwell + pre-play hold so viewer can
            // actually scan the packet contents during silence before
            // narration kicks in. This is the headline beat.
            prePlayHoldMs: 4000,
            quickVoiceText:
              "Now the part that takes fifteen to twenty minutes by hand. Kairos already knows this is an E-P referral. It pulled the right documents — the Holter, the echo at E-F thirty-five, the latest E-C-G, the B-N-P, the med list, plus the insurance card and photo I-D from the Media tab. Cover letter loaded. Fax number populated. Fourteen steps across five Epic screens — collapsed to one click.",
            deepVoiceText:
              "Now the part that takes fifteen to twenty minutes by hand in pure Epic. Kairos already knows this is an electrophysiology referral — not a sleep study, not a G-I consult. So it pulled the documents an E-P actually wants: the Holter that triggered the referral, the most recent echo showing the E-F at thirty-five, the latest E-C-G as a baseline rhythm, the B-N-P trajectory, the active med list, Pendrelle's review note. From the Media tab, the insurance card and photo I-D — those drive the receiving practice's pre-cert workflow. The cover letter is loaded with the right SmartPhrase. The fax number is populated. The packet is ready. Fourteen manual steps across five Epic surfaces — collapsed to one Authorize. The tacit knowledge of which documents matter for which referral type is the moat.",
            body: "Packet — pre-assembled.",
            durationMs: 9000,
          },
          {
            trigger: "after-action",
            ...
            position: "top",
            style: "spotlight",
            audioKey: "beasley-ep-referral-disposition",
            title: "Send. Sign. Place. Fax.",
            displayText: "One click.",
            quickVoiceText:
              "Send the MyChart. Sign the note. Place the referral. Fax the packet to Riverside. One click — all of it.",
            deepVoiceText:
              "Send the MyChart. Sign the note. Place the referral. Fax the packet to Riverside. One click — all of it at once. The thirty seconds of clinical reasoning was the value. The fifteen minutes of plumbing was the cost. Kairos kept the value. Removed the cost.",
            body: "One click.",
            durationMs: 5500,
          },
        ],
    ...
    onAuthorize: {
      anchor: "global",
      style: "narrator-corner",
      audioKey: "beasley-ep-referral-auth",
      targetButton: "authorize",
      cursor: {
        target: "#kairos-action-authorize",
        startTime: 8000,
      ...
      title: "Plumbing collapsed.",
      displayText: "Plumbing collapsed.",
      quickVoiceText:
        "Clinical reasoning was thirty seconds. Plumbing was fifteen to twenty minutes — different tabs, different surfaces, manual judgment about which documents this referral needs. Kairos kept the reasoning, removed the plumbing.",
      deepVoiceText:
        "Clinical reasoning was thirty seconds. The plumbing — pulling the right Holter, the right echo, the right E-C-G, the B-N-P trajectory, the med list, the insurance card and photo I-D from Media, the cover letter, the fax number — was fifteen to twenty minutes across five Epic surfaces. Kairos kept the reasoning. Removed the plumbing. That's the headline.",
      body: "Plumbing collapsed.",
      durationMs: 5800,
    },
