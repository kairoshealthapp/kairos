...
const TOUR_SCRIPT = [
  ...
  // FIXTURE 1 — Aldington TTE (Pattern 2)
  {
    ...
    onAuthorize: {
      ...
      deepVoiceText:
        "One click. Note signed. MyChart sent. Order pended for Beckweldon's cosign. In Epic, this same workflow takes roughly fourteen clicks across five screens. But the bigger story isn't the click count. It's that every T-T-E order Kairos pre-stages has the same thirteen fields filled the same correct way. The floor rises. The senior-nurse depth becomes the floor.",
      body: "One click.",
      durationMs: 5000,
    },
    transitionNarrator: {
  ...
  // FIXTURE 3 — Hesperdale Crestor (Pattern 4)
  {
    ...
    preArrivalNarrator: {
      ...
      deepVoiceText:
        "Ms. Hesperdale, fifty-nine. Lipid panel and chem-eight reviewed. L-D-L one-forty-two, above goal. Dr. Beckweldon wants Crestor uptitrated — twenty milligrams to forty — and a lipid panel plus hepatic function panel rechecked together in ninety days. In Epic, this card is roughly fourteen discrete actions. Watch.",
        ...
        annotations: [
          {
            ...
            deepVoiceText:
              "Discontinue Crestor twenty. Place Crestor forty. The audit-trail note auto-populates from the plan keywords — increasing to forty milligrams from twenty per Beckweldon. The discontinue reason is filled. The cosign route is set. None of this is invented.",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          },
          {
            ...
            deepVoiceText:
              "Ninety days. Three refills. Standard diagnosis. Skarsdale cosign. All of it pulled from the Rx Request rule, not from memory. Same documentation language every time. No drift. No exception slipping through because someone was tired or rushed. And if the rule had flunked — if the patient hadn't been seen in the last month — Kairos would route this to the Support Staff Pool with a note saying needs appointment scheduled before next refill. Not your problem to remember. The system remembers.",
    ...
    actions: [
      {
        ...
        annotations: [
          ...
          },
          {
            ...
            deepVoiceText:
              "The reply itself is brief. Thanks for clarifying. That's a great question, and the best person to answer it is the hematology team Dr. Beckweldon referred you to last week. Doesn't pretend. Doesn't speculate. Doesn't paper over. Routes to who can — and offers to follow up if the referral hasn't been scheduled.",
  ...
  // FIXTURE 9 — Larvendel denial cascade (Pattern 13)
  {
    ...
    preArrivalNarrator: {
      ...
      deepVoiceText:
        "Ms. Larvendel, fifty-eight. Atypical chest pain workup. Eight days ago, Dr. Beckweldon ordered a nuclear S-P-E-C-T. The card you're looking at represents the entire investigation since.",
