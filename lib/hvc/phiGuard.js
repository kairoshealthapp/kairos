...
const STAFF_NAMES = new Set([
  'Ademola','Aikaterini','Ainara','Akselsson','Aleixo','Aletheia','Alkhatib-Vargas','Alvedo',
  'Anand','Anders','Aniela','Aniela-Soto','Aniol','Annwyl','Anouk','Anouska',
  'Anvar','Aprilia','Argyris','Ariadne','Aristarchos','Arman','Arnav','Arsenyev',
  'Astrid','Avalokita','Babic','Banerjee-Ekene','Bartolomeu','Beatrix','Bedoya','Bekele',
  'Belyaev','Bertrand-Olu','Bjorklund','Bjornholm','Bogomil','Bonham-Vatu','Borghese','Boroni',
  'Brandon','Branimir','Branka','Branko','Branwen','Marsbridge','Bryndis','Brynjar',
  'Brzezinski','Burkhardt-Lwin','Calantha','Cassiano','Catalina','Chandrasekhar','Chmielewski','Christofor',
  'Clovis','Constantakis','Cosima','Costanza','Cressida','Crisanto','Crveni','Cwiklinski',
  'Czarnecki','Czerny','Dahlia','Damaskenos','Damir','Daudi','Davorin','Devereux-Asanti',
  'Dimopoulos','Domenico','Doroteja','Drazen','Drobny','Eleni','Elspeth','Holvenmark',
  'Eskil','Espinosa','Eulalia','Faina','Falconieri','Rashid','Fjeldstad','Fjord',
  'Flavian','Flores-Mihalache','Fonseca','Friedrich','Fryderyk','Gajewski','Gavrilov','Gellert',
  'Gildardo','Goransson','Govindan','Gunnarsson','Haavisto','Halmaghi','Halvorsen','Haroun',
  'Hatanaka','Henningsen','Henriksson','Hideo','Hjelmer','Hjorth','Hrubec','Indravan',
  'Jankowicz','Janusz','Jaromir','Jaswant','Jensine','Jeronim','Joaquim','Jokubas',
  'Jorund','Jorvik','Joscelin','Jovan','Jovanka','Jovita-Nwosu','Kaito','Kalindra',
  'Kanazawa','Katarzyna','Kerensa','Kerstin','Kjeld','Kjellberg','Klemensia','Konstantin',
  'Korhonen','Krasimirov','Krishnamoorthi','Krishnamurti','Krystyna','Kuusinen','Kuznetsov','Latorre',
  'Lautaro','Lazaros','Lefkowicz','Leitenberger','Leitmannova','Liang','Eldenfaer','Liljana',
  'Lipinski','Liutauras','Lothar','Lubomirska','Lukasz','Maelis','Maelle','Maeve-Sani',
  'Magnusen','Mahapatra','Maitane','Marcjusz','Markovic','Marusha','Massoud','Mateus',
  'Matsumoto','Maximovsky','Mazurek','Mehdi','Melisande','Mendoza-Iliev','Mihai','Mihailov',
  'Mihaylov','Mikaela','Mikolaj','Mireia-Kalei','Mironenko','Mirthe','Mladenov','Moravec-Adeyemi',
  'Morgenstern','Mostowicz','Movsisyan','Munir','Myrhager','Natanael','Nereida','Nestoras',
  'Nezami','Nyirenda','Okumura','Olufemi','Onuoha','Onyemachi','Panayiotou','Patryk',
  'Pavlenko','Pelagia','Pernille','Petronela','Inwarden','Pevtsov','Phillipakos','Pieniazek',
  'Pilastros','Pillai','Pomerantsev','Prashanth','Qadir','Radmila','Radomir','Radoslav',
  'Ragnar','Rakitin','Rasmussen-Otieno','Razuvaev','Reinholdt','Renske','Rivkin','Rohini',
  'Romanenko','Rostam','Roxana','Saadawi','Saavedra','Sabatino','Salomeya','Sandhu',
  'Sankaran','Saoirse','Saskia','Schlumberger','Severine','Shahriar','Shamsuddin','Shimazaki',
  'Shoshana','Sienkiewicz','Sigourney','Sigurdardottir','Sirvan','Sjoblom','Sokoloff','Sokolov',
  'Solorzano','Solveig','Sorenza','Soroush','Spasoyevich','Sruthi','Stanislav','Stellan',
  'Sterne','Stoyanov','Strzelecki','Sumanth','Sundberg','Suvi','Sviatlana','Tadeusz',
  'Tahirah','Tanyana','Tegner','Tholstrup','Tjorven','Tomescu','Triantafyllos','Tymoteusz',
  'Urbanowicz','Manolinder','Vidmantas','Voskresensky','Vrenne','Vukoslav','Wachowicz','Wieczorek',
  'Wilhelmus','Witkoska','Witkowski','Wojciechowski','Wojnar','Wojtek','Yusupov','Yuvenaly',
  'Zafarullah','Zakharchenko','Zenon','Zikomo','Zoltan',
]);
