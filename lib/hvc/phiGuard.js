...
const STAFF_NAMES = new Set([
  ...
  'Brandon','Branimir','Branka','Branko','Branwen','Brouwer','Bryndis','Brynjar',
  ...
  'Dimopoulos','Domenico','Doroteja','Drazen','Drobny','Eleni','Elspeth','Engelbrecht',
  'Eskil','Espinosa','Eulalia','Faina','Falconieri','Fawzi','Fjeldstad','Fjord',
  ...
  'Lautaro','Lazaros','Lefkowicz','Leitenberger','Leitmannova','Liang','Lieberberg','Liljana',
  ...
  'Pavlenko','Pelagia','Pernille','Petronela','Petrov','Pevtsov','Phillipakos','Pieniazek',
  ...
  'Solorzano','Solveig','Soraya','Soroush','Spasoyevich','Sruthi','Stanislav','Stellan',
  ...
  'Urbanowicz','Vassilakos','Vidmantas','Voskresensky','Vrenne','Vukoslav','Wachowicz','Wieczorek',
