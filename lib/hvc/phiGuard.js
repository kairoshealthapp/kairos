...
const STAFF_NAMES = new Set([
  ...
  'Allison','Almasalmeh','Brindelmore','Amar','Ameer','Andrea','Andrew','Angie',
  'Anita','Anooj','April','Ariella','Armstrong','Arun','Athina','Bach',
  'Baiter','Baker','Hardenkvist','Barbie','Barton','Batchu','Holcrest','Bayless',
  ...
  'Aldermane','Courtney','Cowell','Craig','Crawshaw','Crystal','Tregarthen','Curtis',
  'Dan','Dana','David','Pendrelle','Derrick','Deveney','Donni','Donny',
  'Durbin','Manolinder','Elliotte','Emily','Emmett','Vellacott','Rashid','Feeler',
  'Fern','Field','Fleener','Floyd','Carrowmore','French','Fryer','Fulton',
  'Brindleforth','Quennelford','Gautam','Gdowski','Gifford','Glenn','Gorrell','Harden',
  'Harman','Hartog','Hartupee','Headrick','Heincker','Huang','Huckla','Espelheim',
  ...
  'Jaspermark','Lebedowicz','Lee','Leidenfost','Leidenfrost','Leon','Lisenbe','Logan',
  'Luis','Lynn','Maedgen','Rendelman','Marc','Marcee','Marina','Mark',
  'Martin','Masood','Matt','Matthew','Mazzeo','McBride','Megan','Melissa',
  'Mella','Michael','Michele','Miriam','Mitchell','Moore','Moravec','Holvenmark',
  'Moshirzadeh','Mueen','Muhammad','Sandriden','Myers','Mylhan','Nasser','Nathan',
  'Nichole','Nikolaos','Nurelign',"O'Malley",'Oak','Orizu','Paige','Pajeau',
  'Patel','Patricia','Patrick','Paula','Falkenrath','Pecos','Peterson','Strathorne',
  'Phinney','Phippen','Potter','Prabhu','Halverthorne','Qamar','Rachel','Rachelle',
  'Ratchford','Rebecca','Reidy','Reiss','Richard','Robert','Ronald','Rosa',
  'Roshan','Rowden','Rusten','Quintannon','Sadler','Salli','Norhaven','Sandra',
  'Sara','Sasan','Schlesinger','Schroeder','Pinwell','Shams','Shang','Pelfridge',
  'Shawna','Sherry','Shockley','Shruti','Singh','Sinha','Sintek','Castelvar',
  'Speck','Tarkenbridge','Stacie','Sterne','Steve','Steven','Konstantinos','Sudhir',
  'Susan','Greythorne','Sydney','Syed','Sylvester','Tasha','Terrance','Terrill',
  'Norhelden','Tiffany','Toebben','Tony','Trikalinos','Whitfordel','Marsbridge','Victor',
  'Vorhelden','Voight','Vorhies','Waterworth','Watkins','Wes','Wiggins','William',
  'Wilson','Wiseman','Witham','Yaqoob','Youlo','Zahoor','Zajarias','Zak',
  'Zaman','Velkander',
  'Marley','Larvendrel','Travis','Duke','Quintessar','Mia','Lindmaer',
  'Missie','Carwelden','Kim','Roach','Samantha','Miller',
  'Elizabeth','Tannenbaum','Halsendreth','Amanda','Camberwell','Ashley','Sandholm',
  'Paula','Steve','Sterne','Vorhelden','Konstantinos',
]);
