...
const PATTERNS = [
  ...
  {
    // Pass E §3 — referral-packet variant of Pattern 6. One Generate
    // click drafts note + MyChart + referral order AND assembles the
    // pre-selected fax packet (rendered by ReferralPacketPanel below
    // the four-pane grid). The headline-collapse demo: 14 manual steps
    // across 5 Epic surfaces become a single Authorize.
    id: "6r",
    name: "SYNTHESIS + REFERRAL PACKET",
    trigger: "Cross-specialty referral with auto-assembled fax packet (EP, sleep, GI, etc.)",
    panes: ["source", "nurseNote", "mychart", "orderPad", "referralPacket"],
    actionButtons: [
      { id: "assemble-ep-referral", label: "Assemble EP Referral Packet" },
    ],
    surface: "v1.5",
  },
  {
