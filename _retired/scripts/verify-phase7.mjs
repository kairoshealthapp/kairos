...
// 5. Pre-visit task
const tysander = await fetchOne("kairos_pre_visit_tasks", { id: "pre_visit_cosgrove_001" });
check("Tysander pre-visit task persists", !!tysander);
check("Tysander has 17 reported meds", (tysander?.patient_reported_meds || []).length === 17);
